...
<head>
    ...
    <style>
        ...
        #onesignal-custom-prompt .btn-dismiss:hover {
        ...
        <div class="notif-card">
            ...
            <div id="ios-pwa-message" class="hidden">
                ...
                <p>Pour recevoir les notifications sur iPhone/iPad, ajoutez ManageX à votre écran d'accueil :<br>
                    <strong>Appuyez sur</strong> <span style="font-size:18px">⬆️</span> <strong>puis "Sur l'écran
                        d'accueil"</strong>
                </p>
...
<body class="font-sans antialiased" x-data="{ showLogoutModal: false }">
    ...
    <div class="min-h-screen bg-slate-50">
        ...
        <div id="sidebarBackdrop"
            ...
            class="fixed inset-0 z-40 bg-gray-900/50 backdrop-blur-sm lg:hidden hidden transition-opacity opacity-100">
        </div>

        <!-- Sidebar -->
        <aside
            class="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-slate-200 transform transition-transform duration-200 ease-in-out lg:translate-x-0 -translate-x-full flex flex-col items-center"
            id="sidebar">
            <div class="flex items-center justify-center h-20 w-full border-b border-slate-100"
                style="background-color: #1b3c3505;">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2">
                    <img src="{{ asset('images/logo.png') }}" alt="ManageX Logo"
                        class="h-25 w-full rounded-lg object-contain">
                </a>
            </div>
            ...
            <nav class="mt-6 flex-1 overflow-y-auto">
                <div class="px-4 space-y-2">
                    ...
                    <!-- Gestion RH Dropdown -->
                    <div
                        x-data="{ open: {{ (request()->routeIs('admin.employees.*') || request()->routeIs('admin.presences.*') || request()->routeIs('admin.tasks.*') || request()->routeIs('admin.leaves.*') || request()->routeIs('admin.intern-evaluations.*')) ? 'true' : 'false' }} }">
                        ...
                        <div x-show="open" x-cloak x-transition class="space-y-1 mt-1">
                            <x-sidebar-link :href="route('admin.employees.index')"
                                ...
                                class="pl-12 text-sm">Employés</x-sidebar-link>
                            <x-sidebar-link :href="route('admin.presences.index')"
                                :active="request()->routeIs('admin.presences.*')"
                                class="pl-12 text-sm">Présences</x-sidebar-link>
                            <x-sidebar-link :href="route('admin.tasks.index')"
                                :active="request()->routeIs('admin.tasks.*')"
                                class="pl-12 text-sm">Tâches</x-sidebar-link>
                            <x-sidebar-link :href="route('admin.leaves.index')"
                                :active="request()->routeIs('admin.leaves.*')"
                                class="pl-12 text-sm">Congés</x-sidebar-link>
                            <x-sidebar-link :href="route('admin.intern-evaluations.index')"
                                :active="request()->routeIs('admin.intern-evaluations.*')"
                                class="pl-12 text-sm">Stagiaires</x-sidebar-link>
                        </div>
                    </div>

                    <!-- Paie Dropdown -->
                    <div
                        x-data="{ open: {{ (request()->routeIs('admin.payrolls.*') || request()->routeIs('admin.payroll-settings.*') || request()->routeIs('admin.employee-evaluations.*')) ? 'true' : 'false' }} }">
                        <button @click="open = !open"
                        ...
                        <div x-show="open" x-cloak x-transition class="space-y-1 mt-1">
                            <x-sidebar-link :href="route('admin.employee-evaluations.index')"
                                :active="request()->routeIs('admin.employee-evaluations.*')" class="pl-12 text-sm">
                                Évaluations
                            </x-sidebar-link>
                            <x-sidebar-link :href="route('admin.payrolls.index')"
                                :active="request()->routeIs('admin.payrolls.*')" class="pl-12 text-sm">
                                Fiches de paie
                            </x-sidebar-link>
                            <x-sidebar-link :href="route('admin.payroll-settings.countries')"
                                :active="request()->routeIs('admin.payroll-settings.*')" class="pl-12 text-sm">
                                Config. Paie
                            </x-sidebar-link>
                        </div>
                    </div>
                    ...
                    <div
                        x-data="{ open: {{ (request()->routeIs('admin.surveys.*') || request()->routeIs('admin.announcements.*') || request()->routeIs('admin.documents.*') || request()->routeIs('messaging.*') || request()->routeIs('admin.messaging.*')) ? 'true' : 'false' }} }">
                        <button @click="open = !open"
                        ...
                        <div x-show="open" x-cloak x-transition class="space-y-1 mt-1">
                            <x-sidebar-link :href="route('admin.surveys.index')"
                                :active="request()->routeIs('admin.surveys.*')"
                                class="pl-12 text-sm">Sondages</x-sidebar-link>
                            <x-sidebar-link :href="route('admin.announcements.index')"
                                :active="request()->routeIs('admin.announcements.*')"
                                class="pl-12 text-sm">Annonces</x-sidebar-link>
                            <x-sidebar-link :href="route('admin.documents.index')"
                                :active="request()->routeIs('admin.documents.*')"
                                class="pl-12 text-sm">Documents</x-sidebar-link>
                            <x-sidebar-link :href="route('messaging.admin.chat')"
                                :active="request()->routeIs('messaging.admin.chat')"
                                class="pl-12 text-sm">Chat</x-sidebar-link>
                            <x-sidebar-link :href="route('admin.messaging.index')"
                                :active="request()->routeIs('admin.messaging.*')" class="pl-12 text-sm">Gestion
                    ...
                    <div x-data="{ open: {{ (request()->routeIs('admin.geolocation-zones.*')) ? 'true' : 'false' }} }">
                        ...
                        <div x-show="open" x-cloak x-transition class="space-y-1 mt-1">
                            <x-sidebar-link :href="route('admin.geolocation-zones.index')"
                                :active="request()->routeIs('admin.geolocation-zones.*')" class="pl-12 text-sm">Zones
                                Géoloc.</x-sidebar-link>
                            <x-sidebar-link :href="route('admin.trainings.index')"
                                :active="request()->routeIs('admin.trainings.*')"
                                class="pl-12 text-sm">Formations</x-sidebar-link>
                            <x-sidebar-link :href="route('admin.skills.manage')"
                                :active="request()->routeIs('admin.skills.*')"
                                class="pl-12 text-sm">Compétences</x-sidebar-link>
                            <x-sidebar-link :href="route('admin.bts-evaluations.index')"
                                :active="request()->routeIs('admin.bts-evaluations.*')" class="pl-12 text-sm">Fiches
                                BTS</x-sidebar-link>
                        </div>
                    </div>

                    <x-sidebar-link :href="route('admin.registration-codes.index')"
                        :active="request()->routeIs('admin.registration-codes.index')">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @if(auth()->user()->canAccessStageRequests())
                        <x-sidebar-link :href="route('admin.stage-requests.index')"
                            :active="request()->routeIs('admin.stage-requests.*')">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" @click.away="open = false"
                                ...
                                <div
                                    class="w-8 h-8 rounded-full bg-gradient-to-br from-[#1B3C35] to-[#2D5A4E] flex items-center justify-center text-white text-sm font-semibold overflow-hidden">
                                    @if(auth()->user()->avatar && avatar_url(auth()->user()->avatar))
                                        <img src="{{ avatar_url(auth()->user()->avatar) }}" alt="{{ auth()->user()->name }}"
                                            class="w-full h-full object-cover"
                                            onerror="this.style.display='none'; this.parentElement.textContent=@js(strtoupper(substr(auth()->user()->name, 0, 1)));">
                                    @else
                            ...
                            <div x-show="open" x-cloak x-transition
                                ...
                                <div class="px-4 py-3 border-b border-gray-100">
                                    ...
                                    <span
                                        class="inline-flex items-center px-2 py-0.5 mt-1 rounded-full text-xs font-medium bg-[#E8F0ED] text-[#163530]">
                                        Administrateur
                                    </span>
                                </div>
                                <div class="py-1">
                                ...
                                <div class="border-t border-gray-100 pt-1">
                                    <button type="button" @click="showLogoutModal = true"
                                        class="flex items-center gap-3 w-full px-4 py-2 text-sm text-[#1B3C35] hover:bg-[#F0F5F3]">
    ...
    <div x-show="showLogoutModal" class="fixed inset-0 z-[100] overflow-y-auto" style="display: none;">
        <div x-show="showLogoutModal" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0"
            ...
            class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" @click="showLogoutModal = false"></div>
            ...
            <div x-show="showLogoutModal" x-transition
                ...
                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        <div
                            class="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-[#E8F0ED] sm:mx-0 sm:h-10 sm:w-10">
                            <svg class="h-6 w-6 text-[#1B3C35]" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor">
                ...
                <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    <button type="button" @click="$refs.logoutForm.submit()"
                        class="inline-flex w-full justify-center rounded-md bg-[#1B3C35] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#2D5A4E] sm:ml-3 sm:w-auto">Déconnexion</button>
                    <button type="button" @click="showLogoutModal = false"
                        class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto">Annuler</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="toast-container" class="fixed top-20 right-4 flex flex-col gap-3 pointer-events-none"
