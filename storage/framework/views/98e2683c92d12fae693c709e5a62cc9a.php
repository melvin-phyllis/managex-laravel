                        ...
                        <div>
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-orange-100 text-sm mt-0.5"><?php echo e($geolocationZone->name); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label for="radius" class="block text-sm font-medium text-gray-700 mb-1.5">
                                    Rayon de la zone : <span id="radiusValue" class="font-bold text-amber-600"><?php echo e($geolocationZone->radius); ?></span> métres
                                </label>
