...
// PWA Manifest - Uses relative paths for same-origin compliance
Route::get('/manifest.webmanifest', function () {
    return response()->json([
        'id' => '/managex/public/',
        'name' => 'ManageX - Gestion des Ressources Humaines',
        'short_name' => 'ManageX',
        'description' => 'Application complète de gestion RH : pointage, congés, tâches, paie, évaluations, messagerie interne et sondages. Simplifiez la gestion de vos employés.',
        'start_url' => '/managex/public/login',
        'display' => 'standalone',
        'display_override' => ['standalone', 'minimal-ui'],
        'background_color' => '#ffffff',
        'theme_color' => '#4f46e5',
        'orientation' => 'portrait-primary',
        'scope' => '/managex/public/',
        'dir' => 'ltr',
        'lang' => 'fr-FR',
        'prefer_related_applications' => false,
        'categories' => ['business', 'productivity', 'utilities'],
        'icons' => [
            ['src' => asset('icons/icon-192x192.png'), 'sizes' => '192x192', 'type' => 'image/png', 'purpose' => 'any'],
            ['src' => asset('icons/icon-512x512.png'), 'sizes' => '512x512', 'type' => 'image/png', 'purpose' => 'any'],
            ['src' => asset('icons/icon-192x192.png'), 'sizes' => '192x192', 'type' => 'image/png', 'purpose' => 'maskable'],
            ['src' => asset('icons/icon-512x512.png'), 'sizes' => '512x512', 'type' => 'image/png', 'purpose' => 'maskable'],
        ],
        'shortcuts' => [
            [
                'name' => 'Pointer ma présence',
                'short_name' => 'Pointage',
                'description' => 'Marquer votre arrivée ou départ',
                'url' => '/managex/public/employee/presences',
                'icons' => [['src' => asset('icons/icon-192x192.png'), 'sizes' => '192x192', 'type' => 'image/png']],
            ],
            [
                'name' => 'Mes tâches',
                'short_name' => 'Tâches',
