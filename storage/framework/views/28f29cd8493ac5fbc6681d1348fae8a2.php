...
<?php $component->withAttributes([]); ?>
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <!-- Form -->
        <form action="<?php echo e(route('admin.announcements.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="type" id="type" required
                                class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500">
                            <option value="info" <?php echo e(old('type') === 'info' ? 'selected' : ''); ?>>â„¹ï¸ Information</option>
                            <option value="success" <?php echo e(old('type') === 'success' ? 'selected' : ''); ?>>âœ… Bonne nouvelle</option>
                            <option value="warning" <?php echo e(old('type') === 'warning' ? 'selected' : ''); ?>>âš ï¸ Attention</option>
                            <option value="urgent" <?php echo e(old('type') === 'urgent' ? 'selected' : ''); ?>>ðŸš Urgent</option>
                            <option value="event" <?php echo e(old('type') === 'event' ? 'selected' : ''); ?>>ðŸ“… événement</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="priority" id="priority" required
                            ...
                            <option value="critical" <?php echo e(old('priority') === 'critical' ? 'selected' : ''); ?>>Critique (banniére)</option>
                        </select>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="content" id="content" rows="6" required
                              class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500"
                              placeholder="Rédigez votre annonce..."><?php echo e(old('content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6 animate-fade-in-up animation-delay-300">
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <label class="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                            <input type="radio" name="target_type" value="department" <?php echo e(old('target_type') === 'department' ? 'checked' : ''); ?>
                        ...
                        <label class="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                            <input type="radio" name="target_type" value="position" <?php echo e(old('target_type') === 'position' ? 'checked' : ''); ?>
                        ...
                        <label class="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                            <input type="radio" name="target_type" value="custom" <?php echo e(old('target_type') === 'custom' ? 'checked' : ''); ?>
                    ...
                    <div class="border rounded-lg max-h-60 overflow-y-auto p-2">
                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="flex items-center gap-3 p-2 hover:bg-gray-50 rounded cursor-pointer">
                                ...
                                <span class="text-sm text-gray-500"><?php echo e($emp->email); ?></span>
                            </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4 animate-fade-in-up animation-delay-500">
                ...
                <label class="flex items-center gap-3 cursor-pointer">
                    <input type="checkbox" name="requires_acknowledgment" value="1" <?php echo e(old('requires_acknowledgment') ? 'checked' : ''); ?>
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views\admin\announcements\create.blade.php ENDPATH**/ ?>