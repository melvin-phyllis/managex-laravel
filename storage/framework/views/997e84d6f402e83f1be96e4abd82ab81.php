    ...
    <div class="space-y-6" x-data="employeeEditForm()">
        ...
        <div class="flex items-center justify-between animate-fade-in-up">
            <div>
                ...
                <p class="text-gray-500 mt-1"><?php echo e($employee->name); ?> <span class="text-xs bg-gray-100 px-2 py-1 rounded-full ml-2"><?php echo e($employee->employee_id ?? 'N/A'); ?></span></p>
            </div>
            <div class="flex items-center space-x-3">
                <a href="<?php echo e(route('admin.employees.show', $employee)); ?>" class="inline-flex items-center px-4 py-2 bg-blue-50 text-blue-700 text-sm font-medium rounded-lg hover:bg-blue-100 transition-colors">
        ...
        <!-- Form -->
        <form action="<?php echo e(route('admin.employees.update', $employee)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6 animate-fade-in-up animation-delay-100">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-3 flex items-center space-x-6 pb-4 border-b border-gray-100">
                            <?php if($employee->avatar): ?>
                                <img src="<?php echo e(avatar_url($employee->avatar)); ?>" alt="<?php echo e($employee->name); ?>" class="w-20 h-20 rounded-full object-cover border-4 border-white shadow-lg">
                            <?php else: ?>
                                <div class="w-20 h-20 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center shadow-lg">
                                    <span class="text-white font-bold text-2xl"><?php echo e(strtoupper(substr($employee->name, 0, 2))); ?></span>
                                </div>
                            <?php endif; ?>
                            <div class="flex-1">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" value="<?php echo e(old('email', $employee->email)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="telephone" id="telephone" value="<?php echo e(old('telephone', $employee->telephone)); ?>"
                        ...
                        <div>
                            ...
                            <select name="gender" id="gender" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                                ...
                                <option value="male" <?php echo e(old('gender', $employee->gender) == 'male' ? 'selected' : ''); ?>>Homme</option>
                                <option value="female" <?php echo e(old('gender', $employee->gender) == 'female' ? 'selected' : ''); ?>>Femme</option>
                                <option value="other" <?php echo e(old('gender', $employee->gender) == 'other' ? 'selected' : ''); ?>>Autre</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="status" id="status" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                                ...
                                <option value="on_leave" <?php echo e(old('status', $employee->status) == 'on_leave' ? 'selected' : ''); ?>>En congé</option>
                                <option value="suspended" <?php echo e(old('status', $employee->status) == 'suspended' ? 'selected' : ''); ?>>Suspendu</option>
                                <option value="terminated" <?php echo e(old('status', $employee->status) == 'terminated' ? 'selected' : ''); ?>>Parti</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="password" name="password" id="password"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="city" id="city" value="<?php echo e(old('city', $employee->city)); ?>"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label for="postal_code" class="block text-sm font-medium text-gray-700 mb-1">Code postal</label>
                            <input type="text" name="postal_code" id="postal_code" value="<?php echo e(old('postal_code', $employee->postal_code)); ?>"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label for="country" class="block text-sm font-medium text-gray-700 mb-1">Pays</label>
                            <input type="text" name="country" id="country" value="<?php echo e(old('country', $employee->country ?? 'France')); ?>"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="poste" id="poste" value="<?php echo e(old('poste', $employee->poste)); ?>"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label for="hire_date" class="block text-sm font-medium text-gray-700 mb-1">Date d'embauche</label>
                            <input type="date" name="hire_date" id="hire_date" value="<?php echo e(old('hire_date', $employee->hire_date?->format('Y-m-d'))); ?>"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="contract_type" id="contract_type" x-model="contractType"
                                ...
                                <option value="alternance" <?php echo e(old('contract_type', $employee->contract_type) == 'alternance' ? 'selected' : ''); ?>>Alternance</option>
                                <option value="freelance" <?php echo e(old('contract_type', $employee->contract_type) == 'freelance' ? 'selected' : ''); ?>>Freelance</option>
                        ...
                        <div x-show="['cdd', 'stage', 'alternance', 'interim'].includes(contractType)" x-transition>
                            ...
                            <input type="date" name="contract_end_date" id="contract_end_date" value="<?php echo e(old('contract_end_date', $employee->contract_end_date?->format('Y-m-d'))); ?>"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label for="base_salary" class="block text-sm font-medium text-gray-700 mb-1">Salaire brut mensuel (â‚¬)</label>
                            <input type="number" name="base_salary" id="base_salary" value="<?php echo e(old('base_salary', $employee->base_salary)); ?>" step="0.01" min="0"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div>
                            ...
                            <select name="marital_status" id="marital_status" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                                <option value="single" <?php echo e(old('marital_status', $employee->marital_status) == 'single' ? 'selected' : ''); ?>>Célibataire</option>
                                <option value="married" <?php echo e(old('marital_status', $employee->marital_status) == 'married' ? 'selected' : ''); ?>>Marié(e)</option>
                                <option value="divorced" <?php echo e(old('marital_status', $employee->marital_status) == 'divorced' ? 'selected' : ''); ?>>Divorcé(e)</option>
                                <option value="widowed" <?php echo e(old('marital_status', $employee->marital_status) == 'widowed' ? 'selected' : ''); ?>>Veuf/Veuve</option>
                            </select>
                        </div>

                        <div>
                            <label for="children_count" class="block text-sm font-medium text-gray-700 mb-1">Nombre d'enfants</label>
                            <input type="number" name="children_count" id="children_count" value="<?php echo e(old('children_count', $employee->children_count ?? 0)); ?>" min="0"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label for="cnps_number" class="block text-sm font-medium text-gray-700 mb-1">Numéro CNPS</label>
                            <input type="text" name="cnps_number" id="cnps_number" value="<?php echo e(old('cnps_number', $employee->cnps_number)); ?>"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        
                        <div>
                            <label for="number_of_parts" class="block text-sm font-medium text-gray-700 mb-1">Parts fiscales (Override)</label>
                            <input type="number" name="number_of_parts" id="number_of_parts" value="<?php echo e(old('number_of_parts', $employee->number_of_parts)); ?>" step="0.5" min="1"
                        ...
                        <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="inline-flex items-center px-4 py-2 rounded-lg border border-gray-200 hover:bg-gray-50 cursor-pointer transition-colors has-[:checked]:bg-blue-50 has-[:checked]:border-blue-300">
                                <input type="checkbox" name="work_days[]" value="<?php echo e($value); ?>"
                                       <?php echo e(in_array($value, old('work_days', $employeeWorkDays)) ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" name="emergency_contact_name" id="emergency_contact_name" value="<?php echo e(old('emergency_contact_name', $employee->emergency_contact_name)); ?>"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label for="emergency_contact_phone" class="block text-sm font-medium text-gray-700 mb-1">Téléphone</label>
                            <input type="text" name="emergency_contact_phone" id="emergency_contact_phone" value="<?php echo e(old('emergency_contact_phone', $employee->emergency_contact_phone)); ?>"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="emergency_contact_relationship" id="emergency_contact_relationship"
                                    class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                                <option value="">Sélectionner</option>
                                <option value="Conjoint(e)" <?php echo e(old('emergency_contact_relationship', $employee->emergency_contact_relationship) == 'Conjoint(e)' ? 'selected' : ''); ?>>Conjoint(e)</option>
                                <option value="Parent" <?php echo e(old('emergency_contact_relationship', $employee->emergency_contact_relationship) == 'Parent' ? 'selected' : ''); ?>>Parent</option>
                                <option value="Enfant" <?php echo e(old('emergency_contact_relationship', $employee->emergency_contact_relationship) == 'Enfant' ? 'selected' : ''); ?>>Enfant</option>
                                <option value="Frére/SÅ“ur" <?php echo e(old('emergency_contact_relationship', $employee->emergency_contact_relationship) == 'Frére/SÅ“ur' ? 'selected' : ''); ?>>Frére/SÅ“ur</option>
                                <option value="Ami(e)" <?php echo e(old('emergency_contact_relationship', $employee->emergency_contact_relationship) == 'Ami(e)' ? 'selected' : ''); ?>>Ami(e)</option>
                                <option value="Autre" <?php echo e(old('emergency_contact_relationship', $employee->emergency_contact_relationship) == 'Autre' ? 'selected' : ''); ?>>Autre</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" name="social_security_number" id="social_security_number" value="<?php echo e(old('social_security_number', $employee->social_security_number)); ?>"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label for="bank_iban" class="block text-sm font-medium text-gray-700 mb-1">IBAN</label>
                            <input type="text" name="bank_iban" id="bank_iban" value="<?php echo e(old('bank_iban', $employee->bank_iban)); ?>"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label for="bank_bic" class="block text-sm font-medium text-gray-700 mb-1">BIC</label>
                            <input type="text" name="bank_bic" id="bank_bic" value="<?php echo e(old('bank_bic', $employee->bank_bic)); ?>"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="number" name="leave_balance" id="leave_balance" value="<?php echo e(old('leave_balance', $employee->leave_balance ?? 25)); ?>" step="0.5" min="0"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label for="rtt_balance" class="block text-sm font-medium text-gray-700 mb-1">RTT (jours)</label>
                            <input type="number" name="rtt_balance" id="rtt_balance" value="<?php echo e(old('rtt_balance', $employee->rtt_balance ?? 0)); ?>" step="0.5" min="0"
                                   class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label for="sick_leave_balance" class="block text-sm font-medium text-gray-700 mb-1">Congés maladie (jours)</label>
                            <input type="number" name="sick_leave_balance" id="sick_leave_balance" value="<?php echo e(old('sick_leave_balance', $employee->sick_leave_balance ?? 0)); ?>" step="0.5" min="0"
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6">
                    <textarea name="notes" id="notes" rows="4"
                              class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500"
                              placeholder="Notes internes sur l'employé (non visible par l'employé)..."><?php echo e(old('notes', $employee->notes)); ?></textarea>
                </div>
            </div>
    ...
    <script nonce="<?php echo e($cspNonce ?? ''); ?>">
        function employeeEditForm() {
            return {
                departmentId: '<?php echo e(old('department_id', $employee->department_id ?? '')); ?>',
                positionId: '<?php echo e(old('position_id', $employee->position_id ?? '')); ?>',
                contractType: '<?php echo e(old('contract_type', $employee->contract_type ?? 'cdi')); ?>',
                positions: [],
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views\admin\employees\edit.blade.php ENDPATH**/ ?>