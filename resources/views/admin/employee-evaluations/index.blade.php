        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 animate-fade-in-up animation-delay-100">
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-2xl font-bold text-gray-900">{{ $validatedCount }}</span>
                </div>
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-2xl font-bold text-gray-900">{{ number_format($smic, 0, ',', ' ') }}</span>
                </div>
                            ...
                            @foreach($evaluations as $evaluation)
                                <tr class="hover:bg-purple-50/50 transition-colors group">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-500">{{ $evaluation->user->poste ?? 'Employé' }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <span class="font-bold text-gray-700">{{ $evaluation->calculated_salary_formatted }}</span>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end space-x-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            @if($evaluation->canBeEdited())
                                                <a href="{{ route('admin.employee-evaluations.edit', $evaluation) }}" class="p-1.5 text-gray-500 hover:text-amber-600 hover:bg-amber-50 rounded-lg transition-colors" title="Modifier">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
