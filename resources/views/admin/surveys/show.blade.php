                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <form action="{{ route('admin.surveys.destroy', $survey) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce sondage ?')">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="w-full px-4 py-2.5 font-medium rounded-xl transition-colors flex items-center justify-center gap-2 border" style="background-color: rgba(239, 68, 68, 0.1); color: #EF4444; border-color: rgba(239, 68, 68, 0.2);" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'">
                                    ...
                                    <div class="ml-4 flex-1">
                                        <div class="flex items-center justify-between">
                                            ...
                                            @if($question->is_required)
                                                <span class="flex items-center gap-1 text-xs font-medium px-2 py-0.5 rounded-full" style="background-color: rgba(239, 68, 68, 0.1); color: #EF4444;">
                                                    Obligatoire
                                                </span>
                                            @endif
                                        </div>
