...
<?php endif; ?>
            ...
            <div class="text-center">
                <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center gap-2 text-sm text-blue-600 hover:text-blue-800 font-medium transition-colors">
    ...
    <p class="text-center text-sm text-gray-500 mt-6">
        &copy; <?php echo e(date('Y')); ?> ManageX. Tous droits reserves.
    </p>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>