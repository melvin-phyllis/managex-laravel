        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-2xl font-bold" style="color: #8590AA;"><?php echo e($stats['pending'] ?? 0); ?></p>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-2xl font-bold" style="color: #3B8BEB;"><?php echo e($stats['approved'] ?? 0); ?></p>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-2xl font-bold" style="color: #B23850;"><?php echo e($stats['rejected'] ?? 0); ?></p>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium" style="background-color: <?php echo e($type['bg']); ?>; color: <?php echo e($type['text']); ?>;">
                                                        ...
                                                        <div class="relative z-10 w-full max-w-md p-6 mx-auto bg-white rounded-2xl shadow-xl"
                                                            ...
                                                            <div class="mb-4">
                                                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium" 
                                                                      style="background-color: <?php echo e($leave->statut === 'approved' ? 'rgba(59, 139, 235, 0.15)' : 'rgba(178, 56, 80, 0.15)'); ?>; color: <?php echo e($leave->statut === 'approved' ? '#3B8BEB' : '#B23850'); ?>;">
