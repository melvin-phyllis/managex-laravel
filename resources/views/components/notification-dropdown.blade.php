                    ...
                    <a href="{{ $notifUrl }}" class="block px-4 py-3 hover:bg-gray-50 border-b border-gray-50">
                        <div class="flex items-start gap-3">
                            <div class="flex-shrink-0 w-8 h-8 rounded-full {{ $iconClass }} flex items-center justify-center">
                                ...
                                @elseif($notifType === 'task_assigned' || $notifType === 'task_reminder' || $notifType === 'task_status')
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                @elseif($notifType === 'new_evaluation' || $notifType === 'missing_evaluation' || $notifType === 'missing_evaluation_alert' || $notifType === 'weekly_evaluation_reminder' || $notifType === 'evaluation_reminder')
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
