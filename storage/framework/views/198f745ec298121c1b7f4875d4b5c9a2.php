...
<?php endif; ?>
        ...
        <div class="rounded-2xl p-4 flex items-center gap-3" style="background-color: rgba(59, 139, 235, 0.1); border: 1px solid rgba(59, 139, 235, 0.2);">
            <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'alert-circle','class' => 'w-5 h-5','style' => 'color: #3B8BEB;']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'alert-circle','class' => 'w-5 h-5','style' => 'color: #3B8BEB;']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
                ...
                <?php $__currentLoopData = $criteria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $criterion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="text-2xl font-bold" style="color: #3B8BEB;" x-text="scores.<?php echo e($key); ?>.toFixed(1) + '/2.5'"></div>
                        </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 space-y-4">
                ...
                <div>
                    ...
                    <textarea name="general_comment" 
                              rows="4" 
                              class="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-[#3B8BEB] focus:border-[#3B8BEB] resize-none"><?php echo e(old('general_comment', $evaluation->general_comment)); ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="objectives_next_week" 
                              rows="3" 
                              class="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-[#3B8BEB] focus:border-[#3B8BEB] resize-none"><?php echo e(old('objectives_next_week', $evaluation->objectives_next_week)); ?></textarea>
                </div>
            </div>
...
<?php /**PATH D:\ManageX\resources\views/tutor/evaluations/edit.blade.php ENDPATH**/ ?>