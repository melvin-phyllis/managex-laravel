                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <h1 class="text-2xl md:text-3xl font-bold text-white flex items-center gap-3">
                            ...
                            Champs Dynamiques - <?php echo e($country->name); ?>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-purple-50/50 transition-colors group">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="font-mono text-sm bg-gray-100 px-2.5 py-1 rounded-lg"><?php echo e($field->field_name); ?></span>
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-900"><?php echo e($field->field_label); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap">
