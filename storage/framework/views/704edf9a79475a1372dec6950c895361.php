                        ...
                        <div class="grid grid-cols-2 gap-4 text-sm">
                            <div>
                                ...
                                <p class="font-medium text-gray-900 flex items-center gap-2 mt-1">
                                    <span class="text-lg"><?php echo e($globalDocument->file_icon); ?></span>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="text-center mb-4">
                            <div class="text-4xl font-bold text-emerald-600"><?php echo e($acknowledgedCount); ?>/<?php echo e($totalEmployees); ?></div>
                            <p class="text-gray-500 text-sm mt-1">employés ont accusé réception</p>
                        </div>

                        <div class="w-full bg-gray-200 rounded-full h-2 mb-4">
                            <div class="bg-emerald-600 h-2 rounded-full transition-all" style="width: <?php echo e($percentage); ?>%"></div>
                        </div>
