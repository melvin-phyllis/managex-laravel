            ...
            <div class="relative p-6 md:p-8">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <p class="text-white/80 mt-2"><?php echo e($announcement->title); ?></p>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="type" id="type" required
                                class="w-full px-4 py-2.5 rounded-xl border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500">
                            <option value="info" <?php echo e(old('type', $announcement->type) === 'info' ? 'selected' : ''); ?>>ℹ️ Information</option>
                            <option value="success" <?php echo e(old('type', $announcement->type) === 'success' ? 'selected' : ''); ?>>✅ Bonne nouvelle</option>
                            <option value="warning" <?php echo e(old('type', $announcement->type) === 'warning' ? 'selected' : ''); ?>>⚠️ Attention</option>
                            <option value="urgent" <?php echo e(old('type', $announcement->type) === 'urgent' ? 'selected' : ''); ?>>🚨 Urgent</option>
                            <option value="event" <?php echo e(old('type', $announcement->type) === 'event' ? 'selected' : ''); ?>>📅 Événement</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="priority" id="priority" required
                            ...
                            <option value="critical" <?php echo e(old('priority', $announcement->priority) === 'critical' ? 'selected' : ''); ?>>Critique (bannière)</option>
                        </select>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="content" id="content" rows="6" required
                              class="w-full px-4 py-2.5 rounded-xl border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500"><?php echo e(old('content', $announcement->content)); ?></textarea>
