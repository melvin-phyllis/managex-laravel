...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        ...
        <form action="<?php echo e(route('admin.geolocation-zones.store')); ?>" method="POST" id="zoneForm">
            <?php echo csrf_field(); ?>

            <!-- Champs cachés pour les coordonnées -->
            <input type="hidden" name="latitude" id="latitude" value="<?php echo e(old('latitude', '48.8566')); ?>">
            <input type="hidden" name="longitude" id="longitude" value="<?php echo e(old('longitude', '2.3522')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="2"
                                          class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors"
                                          placeholder="Description optionnelle de cette zone..."><?php echo e(old('description')); ?></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="address" id="address" value="<?php echo e(old('address')); ?>" readonly
                            ...
                            <div>
                                ...
                                <input type="range" name="radius" id="radius" value="<?php echo e(old('radius', 100)); ?>"
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views/admin/geolocation-zones/create.blade.php ENDPATH**/ ?>