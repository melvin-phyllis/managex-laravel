...
<?php $component->withAttributes([]); ?>
    <div class="min-h-screen">
        <!-- Header -->
        <div class="bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700 rounded-2xl lg:rounded-3xl mx-4 sm:mx-6 lg:mx-8 mt-4 sm:mt-6 p-6 sm:p-8 text-white shadow-xl relative overflow-hidden">
            <!-- Decorative elements -->
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                ...
                                <p class="text-emerald-100 text-sm sm:text-base mt-1">Gérez les périmètres autorisés pour le pointage</p>
                            </div>
                        </div>
                    </div>
                    <a href="<?php echo e(route('admin.geolocation-zones.create')); ?>" 
                       class="inline-flex items-center justify-center gap-2 px-5 py-3 bg-white text-emerald-700 font-semibold rounded-xl hover:bg-emerald-50 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mt-6">
                    <div class="bg-white/15 backdrop-blur-sm rounded-xl p-3 sm:p-4">
                        <div class="flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                                <p class="text-xl sm:text-2xl font-bold"><?php echo e($zones->total()); ?></p>
                                <p class="text-xs sm:text-sm text-emerald-100">Zones</p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white/15 backdrop-blur-sm rounded-xl p-3 sm:p-4">
                        <div class="flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                                <p class="text-xl sm:text-2xl font-bold"><?php echo e($zones->where('is_active', true)->count()); ?></p>
                                <p class="text-xs sm:text-sm text-emerald-100">Actives</p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white/15 backdrop-blur-sm rounded-xl p-3 sm:p-4">
                        <div class="flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                                <p class="text-xl sm:text-2xl font-bold"><?php echo e($zones->where('is_default', true)->count()); ?></p>
                                <p class="text-xs sm:text-sm text-emerald-100">Par défaut</p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white/15 backdrop-blur-sm rounded-xl p-3 sm:p-4">
                        <div class="flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                                <p class="text-xl sm:text-2xl font-bold"><?php echo e($zones->sum('presences_count')); ?></p>
                                <p class="text-xs sm:text-sm text-emerald-100">Pointages</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div class="flex items-center gap-2">
                                                    <span class="font-semibold text-gray-900"><?php echo e($zone->name); ?></span>
                                                ...
                                                <?php if($zone->address): ?>
                                                    <p class="text-sm text-gray-500 mt-0.5 max-w-xs truncate"><?php echo e($zone->address); ?></p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-sm text-gray-600 font-mono">
                                                <?php echo e(number_format($zone->latitude, 4)); ?>, <?php echo e(number_format($zone->longitude, 4)); ?>
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center gap-1 px-3 py-1.5 bg-blue-50 text-blue-700 rounded-lg text-sm font-medium">
                                            ...
                                            <?php echo e($zone->presences_count); ?>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-end gap-2">
                                            <a href="<?php echo e(route('admin.geolocation-zones.show', $zone)); ?>"
                                            ...
                                            <a href="<?php echo e(route('admin.geolocation-zones.edit', $zone)); ?>"
                                            ...
                                            <?php if(!$zone->is_default): ?>
                                                <form action="<?php echo e(route('admin.geolocation-zones.set-default', $zone)); ?>" method="POST" class="inline">
                                                    <?php echo csrf_field(); ?>
                                            ...
                                            <?php endif; ?>
                                            <form action="<?php echo e(route('admin.geolocation-zones.destroy', $zone)); ?>" method="POST" class="inline"
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div class="flex items-center gap-2 flex-wrap">
                                                <h3 class="font-bold text-gray-900"><?php echo e($zone->name); ?></h3>
                                                <?php if($zone->is_default): ?>
                                                    <span class="px-2 py-0.5 text-xs font-medium rounded-full bg-amber-100 text-amber-700 border border-amber-200">
                                                        Par défaut
                                                    </span>
                                            ...
                                            <?php if($zone->address): ?>
                                                <p class="text-sm text-gray-500 mt-0.5"><?php echo e(Str::limit($zone->address, 40)); ?></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <?php if($zone->is_active): ?>
                            ...
                            <div class="grid grid-cols-3 gap-px bg-gray-100">
                                <div class="bg-white p-3 text-center">
                                    ...
                                    <p class="text-xs font-mono text-gray-700"><?php echo e(number_format($zone->latitude, 3)); ?>, <?php echo e(number_format($zone->longitude, 3)); ?></p>
                                </div>
                                <div class="bg-white p-3 text-center">
                                    <p class="text-xs text-gray-500 mb-1">Rayon</p>
                                    <p class="text-sm font-semibold text-purple-600"><?php echo e($zone->radius); ?> m</p>
                                </div>
                                <div class="bg-white p-3 text-center">
                                    <p class="text-xs text-gray-500 mb-1">Pointages</p>
                                    <p class="text-sm font-semibold text-blue-600"><?php echo e($zone->presences_count); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="p-3 bg-gray-50 flex items-center justify-between gap-2">
                                ...
                                <div class="flex items-center gap-1">
                                    <?php if(!$zone->is_default): ?>
                                        <form action="<?php echo e(route('admin.geolocation-zones.set-default', $zone)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
                                            <button type="submit"
                                    ...
                                    <?php endif; ?>
                                    <form action="<?php echo e(route('admin.geolocation-zones.destroy', $zone)); ?>" method="POST"
                                          onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette zone ?')">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="submit"
            ...
            <?php else: ?>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 sm:p-12 text-center">
                    <div class="max-w-md mx-auto">
                        ...
                        <a href="<?php echo e(route('admin.geolocation-zones.create')); ?>" 
                           class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-xl hover:from-emerald-700 hover:to-teal-700 transition-all shadow-lg hover:shadow-xl">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                            </svg>
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views\admin\geolocation-zones\index.blade.php ENDPATH**/ ?>