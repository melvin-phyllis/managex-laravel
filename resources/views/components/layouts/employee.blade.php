        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 transform transition-transform duration-200 ease-in-out lg:translate-x-0 -translate-x-full flex flex-col" id="sidebar">
            ...
            <nav class="mt-6 flex-1 overflow-y-auto">
                <div class="px-4 space-y-2">
                    ...
                    <x-sidebar-link :href="route('admin.stage-requests.index')" :active="request()->routeIs('admin.stage-requests.*')">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <x-sidebar-link :href="route('employee.trainings.index')" :active="request()->routeIs('employee.trainings.*')">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <x-sidebar-link :href="route('employee.skills.index')" :active="request()->routeIs('employee.skills.*')">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
