    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                <div class="flex items-center">
                    <div class="p-4 rounded-xl" style="background-color: rgba(45, 90, 78, 0.15);">
                        <x-icon name="users" class="w-8 h-8" style="color: #2D5A4E;" />
                    </div>
                    <div class="ml-4">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                <div class="flex items-center">
                    <div class="p-4 rounded-xl" style="background-color: rgba(132, 206, 235, 0.15);">
                        <x-icon name="help-circle" class="w-8 h-8" style="color: #3D7A6A;" />
                    </div>
                    <div class="ml-4">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                <div class="flex items-center">
                    <div class="p-4 rounded-xl" style="background-color: rgba(27, 60, 53, 0.15);">
                        <x-icon name="activity" class="w-8 h-8" style="color: #1B3C35;" />
                    </div>
                    <div class="ml-4">
                    ...
                    <div class="p-6">
                                ...
                                @foreach($stats['distribution'] as $option => $data)
                                    <div>
                                        ...
                                        <div class="w-full bg-gray-100 rounded-full h-3 overflow-hidden">
                                            <div class="h-3 rounded-full transition-all duration-500" style="width: {{ $data['percentage'] }}%; background: linear-gradient(90deg, #1B3C35, #2D5A4E);"></div>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                        @elseif($question->type === 'rating')
                            ...
                            <div class="flex flex-col sm:flex-row gap-8">
                                <div class="flex flex-col items-center justify-center rounded-xl p-6 min-w-[200px]" style="background-color: rgba(45, 90, 78, 0.08);">
                                    ...
                                    <div class="mt-3 flex items-center gap-1">
                                        @for($i = 1; $i <= 5; $i++)
                                            <x-icon name="star" class="w-6 h-6" style="color: {{ $i <= round($average) ? '#2D5A4E' : '#D1D5DB' }}; fill: {{ $i <= round($average) ? '#2D5A4E' : 'none' }};" />
                                        @endfor
                                    </div>
                                </div>
                                    ...
                                    @for($i = 5; $i >= 1; $i--)
                                        ...
                                        <div class="flex items-center gap-3">
                                            <div class="flex items-center gap-1 w-12 justify-end">
                                                ...
                                                <x-icon name="star" class="w-4 h-4" style="color: #2D5A4E; fill: #2D5A4E;" />
                                            </div>
                                            <div class="flex-1 h-2.5 bg-gray-100 rounded-full overflow-hidden">
                                                <div class="h-2.5 rounded-full transition-all duration-500" style="width: {{ $percentage }}%; background: linear-gradient(90deg, #1B3C35, #2D5A4E);"></div>
                                            </div>
