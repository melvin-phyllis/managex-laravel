            ...
            <div class="relative p-6 md:p-8">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <a href="<?php echo e(route('admin.tasks.create')); ?>" class="px-4 py-2.5 bg-white font-semibold rounded-xl hover:bg-purple-50 transition-all shadow-lg flex items-center" style="color: #5680E9;">
            ...
            <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    <div class="flex items-center justify-between">
                        <div class="w-10 h-10 rounded-lg flex items-center justify-center" style="background-color: <?php echo e($stat['bg']); ?>;">
                            <?php if($stat['icon'] === 'clipboard-list'): ?>
  <svg class="w-5 h-5" style="color: <?php echo e($stat['color']); ?>;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
                            <?php elseif($stat['icon'] === 'clock'): ?>
                                <svg class="w-5 h-5" style="color: <?php echo e($stat['color']); ?>;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            <?php elseif($stat['icon'] === 'play'): ?>
                                <svg class="w-5 h-5" style="color: <?php echo e($stat['color']); ?>;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            <?php elseif($stat['icon'] === 'check'): ?>
                                <svg class="w-5 h-5" style="color: <?php echo e($stat['color']); ?>;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            ...
                            <?php elseif($stat['icon'] === 'exclamation'): ?>
                                <svg class="w-5 h-5" style="color: <?php echo e($stat['color']); ?>;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
                            <?php endif; ?>
                        </div>
                            ...
                            <?php $__currentLoopData = $kanbanTasks->get($status, collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="kanban-card bg-white rounded-lg p-3 shadow-sm border border-gray-100 hover:shadow-md transition-all cursor-grab active:cursor-grabbing group"
                                    ...
                                    <div class="w-full bg-gray-100 rounded-full h-1 mt-2">
                                        <div class="h-1 rounded-full transition-all" style="width: <?php echo e($task->progression); ?>%; background-color: <?php echo e($task->progression < 30 ? '#8860D0' : ($task->progression < 70 ? '#84CEEB' : '#5AB9EA')); ?>;"></div>
                                    </div>
                                    <!-- Actions on hover -->
                            ...
                            <div class="flex items-center gap-3">
                                <div class="flex-1 h-2 bg-gray-100 rounded-full overflow-hidden">
                                    <div class="h-full rounded-full transition-all duration-500"
                                         style="width: <?php echo e($task->progression); ?>%; background-color: <?php echo e($task->progression < 30 ? '#8860D0' : ($task->progression < 70 ? '#84CEEB' : '#5AB9EA')); ?>;"></div>
                                </div>
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views/admin/tasks/index.blade.php ENDPATH**/ ?>