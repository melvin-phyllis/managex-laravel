<x-layouts.admin>
    <div class="space-y-6" x-data="employeeEditForm()">
        ...
        <form action="{{ route('admin.employees.update', $employee) }}" method="POST" enctype="multipart/form-data" class="space-y-6 animate-fade-in-up animation-delay-100">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-3 flex items-center space-x-6 pb-4 border-b border-gray-100">
                            ...
                            @else
                                <div class="w-20 h-20 rounded-xl flex items-center justify-center shadow-lg" style="background: linear-gradient(135deg, #1B3C35, #3D7A6A);">
                            ...
                            <div class="flex-1">
                                ...
                                <input type="file" name="avatar" id="avatar" accept="image/*"
                                       class="w-full rounded-xl border border-gray-300 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:text-white hover:file:opacity-90" style="--tw-file-bg: #1B3C35;">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $employee->name) }}" required
                                   class="w-full rounded-xl border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E] @error('name') border-[#2D5A4E] @enderror">
                            @error('name')
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email', $employee->email) }}" required
                                   class="w-full rounded-xl border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E] @error('email') border-[#2D5A4E] @enderror">
                            @error('email')
                                <p class="mt-1 text-sm text-[#1B3C35]">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <select name="gender" id="gender" class="w-full rounded-xl border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E]">
                        ...
                        <div>
                            ...
                            <select name="status" id="status" class="w-full rounded-xl border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E]">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="password" name="password" id="password"
                                   class="w-full rounded-xl border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E] @error('password') border-[#2D5A4E] @enderror">
                            @error('password')
                                <p class="mt-1 text-sm text-[#1B3C35]">{{ $message }}</p>
                            @enderror
            ...
            <!-- Section 3: Adresse -->
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100" style="background: linear-gradient(135deg, #2D5A4E, #3D7A6A);">
                    <h2 class="text-lg font-semibold text-white flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <select name="country" id="country" class="w-full rounded-xl border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E]">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <select name="position_id" id="position_id" x-model="positionId" :disabled="!departmentId"
                                    class="w-full rounded-xl border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E] disabled:bg-gray-100">
                        ...
                        <div x-show="contractType === 'stage'" x-transition>
                            ...
                            <select name="intern_type" id="intern_type"
                                    class="w-full rounded-xl border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E]">
                                <option value="normal" {{ old('intern_type', $employee->intern_type) == 'normal' ? 'selected' : '' }}>Normal</option>
                                <option value="bts" {{ old('intern_type', $employee->intern_type) == 'bts' ? 'selected' : '' }}>BTS</option>
                            </select>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100" style="background: linear-gradient(135deg, #2D5A4E, #1B3C35);">
                    <h2 class="text-lg font-semibold text-white flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div>
                            ...
                            <select name="marital_status" id="marital_status" class="w-full rounded-xl border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E]">
                        ...
                        <div>
                            ...
                            <input type="number" name="number_of_parts" id="number_of_parts" value="{{ old('number_of_parts', $employee->number_of_parts) }}" step="0.5" min="1"
                                   class="w-full rounded-xl border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E]" placeholder="Auto par défaut">
                ...
                <div class="p-6">
                    <div class="flex flex-wrap gap-4">
                        ...
                        @foreach($days as $value => $label)
                            <label class="inline-flex items-center px-4 py-2 rounded-xl border border-gray-200 hover:bg-[#FBF7F0] cursor-pointer transition-colors has-[:checked]:bg-[#F0F5F3] has-[:checked]:border-[#8FB5A8]">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100" style="background: linear-gradient(135deg, #1B3C35, #C8A96E);">
                    <h2 class="text-lg font-semibold text-white flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="sick_leave_balance" id="sick_leave_balance" value="{{ old('sick_leave_balance', $employee->sick_leave_balance ?? 0) }}" step="0.5" min="0"
                                   class="w-full rounded-xl border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E]" readonly>
            ...
            <div class="flex items-center justify-end space-x-4 py-4">
                ...
                <button type="submit" class="px-6 py-2.5 text-white font-semibold rounded-xl transition-all shadow-lg flex items-center" style="background: linear-gradient(135deg, #1B3C35, #2D5A4E);">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
