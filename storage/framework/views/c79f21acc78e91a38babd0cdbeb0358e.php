            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-700 px-6 py-8">
                <div class="flex items-center gap-6">
                    ...
                    <div class="text-white">
                        ...
                        <p class="text-blue-100"><?php echo e($user->position?->name ?? $user->poste ?? 'Employé'); ?></p>
                        <p class="text-blue-200 text-sm mt-1"><?php echo e($user->department?->name ?? 'Non assigné'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 divide-x divide-gray-100 bg-gray-50">
                ...
                <div class="px-6 py-4 text-center">
                    <p class="text-2xl font-bold text-gray-900">
                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($user->status === 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
