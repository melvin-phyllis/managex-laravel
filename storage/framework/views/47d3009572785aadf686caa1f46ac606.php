        ...
        <div class="bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-600 rounded-2xl p-6 text-white shadow-xl">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold mb-1"><?php echo e($intern->name); ?></h1>
                        ...
                        <?php $__currentLoopData = $criteria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div>
                                <div class="flex justify-between text-sm mb-1">
                                    ...
                                    <span class="font-semibold text-gray-900"><?php echo e($averages[$key]); ?>/2.5</span>
                                </div>
                                <div class="w-full bg-gray-100 rounded-full h-2">
                                    <div class="h-2 rounded-full bg-gradient-to-r from-<?php echo e($info['color']); ?>-500 to-<?php echo e($info['color']); ?>-600" 
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__currentLoopData = $evaluations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evaluation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center text-sm text-gray-600"><?php echo e($evaluation->discipline_score); ?>/2.5</td>
                                    <td class="px-6 py-4 text-center text-sm text-gray-600"><?php echo e($evaluation->behavior_score); ?>/2.5</td>
                                    <td class="px-6 py-4 text-center text-sm text-gray-600"><?php echo e($evaluation->skills_score); ?>/2.5</td>
                                    <td class="px-6 py-4 text-center text-sm text-gray-600"><?php echo e($evaluation->communication_score); ?>/2.5</td>
                                    <td class="px-6 py-4 text-center">
                                        ...
                                        ?>
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-bold <?php echo e($gradeColor); ?>">
                    ...
                    <?php $__currentLoopData = $evaluations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evaluation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="p-4">
                            <div class="flex items-center justify-between mb-3">
                                <span class="font-semibold text-gray-900"><?php echo e($evaluation->week_label); ?></span>
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-bold <?php echo e($gradeColor); ?>">
                                    <?php echo e($evaluation->total_score); ?>/10
                                </span>
                            </div>
                            <div class="grid grid-cols-2 gap-2 text-sm">
                                <div class="flex justify-between bg-gray-50 rounded-lg px-3 py-2">
                                    ...
                                    <span class="font-medium"><?php echo e($evaluation->discipline_score); ?>/2.5</span>
                                </div>
                                <div class="flex justify-between bg-gray-50 rounded-lg px-3 py-2">
                                    <span class="text-gray-500">Comportement</span>
                                    <span class="font-medium"><?php echo e($evaluation->behavior_score); ?>/2.5</span>
                                </div>
                                <div class="flex justify-between bg-gray-50 rounded-lg px-3 py-2">
                                    <span class="text-gray-500">Compétences</span>
                                    <span class="font-medium"><?php echo e($evaluation->skills_score); ?>/2.5</span>
                                </div>
                                <div class="flex justify-between bg-gray-50 rounded-lg px-3 py-2">
                                    <span class="text-gray-500">Communication</span>
                                    <span class="font-medium"><?php echo e($evaluation->communication_score); ?>/2.5</span>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views\tutor\evaluations\history.blade.php ENDPATH**/ ?>