        ...
        <div class="rounded-2xl p-6 text-white shadow-xl" style="background-color: #3B8BEB;">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p style="color: #C4DBF6;">Semaine du {{ now()->startOfWeek()->format('d/m/Y') }} au {{ now()->endOfWeek()->format('d/m/Y') }}</p>
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-2xl font-bold" style="color: #3B8BEB;">{{ $stats['evaluated_this_week'] }}</p>
            ...
            <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-2xl font-bold" style="color: #8590AA;">{{ $stats['pending'] }}</p>
