<x-layouts.admin>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ route('admin.analytics.index') }}"
                   class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-medium rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg shadow-blue-500/25">
  ...
  <!-- KPIs avancés -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-5 text-white animate-fade-in-up">
            ...
            <div class="bg-gradient-to-br from-red-500 to-red-600 rounded-2xl p-5 text-white animate-fade-in-up animation-delay-100">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-5 text-white animate-fade-in-up animation-delay-200">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-5 text-white animate-fade-in-up animation-delay-300">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 animate-fade-in-up">
                ...
                <div class="space-y-3">
                    <a href="{{ route('admin.tasks.index', ['statut' => 'pending']) }}"
                       class="flex items-center justify-between p-3 bg-yellow-50 rounded-xl hover:bg-yellow-100 transition-colors group">
                    ...
                    <a href="{{ route('admin.leaves.index', ['statut' => 'pending']) }}"
                       class="flex items-center justify-between p-3 bg-purple-50 rounded-xl hover:bg-purple-100 transition-colors group">
                        <div class="flex items-center">
