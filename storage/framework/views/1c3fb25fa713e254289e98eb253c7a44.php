        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 bg-gradient-to-r from-green-500 to-emerald-600 text-white">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-xl font-bold"><?php echo e($type->name); ?></h1>
                        <p class="text-white/80"><?php echo e($type->category->name); ?></p>
                    </div>
                </div>
            </div>
            ...
            <?php if($type->description): ?>
                <div class="p-4 bg-blue-50 border-b border-blue-100">
                    <p class="text-sm text-blue-700">â„¹ï¸ <?php echo e($type->description); ?></p>
                </div>
            <?php endif; ?>

            <?php if($type->requires_validation): ?>
            ...
            <!-- Form -->
            <form action="<?php echo e(route('employee.documents.store')); ?>" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="document_type_id" value="<?php echo e($type->id); ?>">
                ...
                <div>
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-green-400 transition-colors cursor-pointer"
                        ...
                        <input type="file" name="file" id="file" required class="hidden" 
                               accept=".<?php echo e(implode(',.', $type->allowed_extensions ?? ['pdf', 'jpg', 'jpeg', 'png'])); ?>">
                        <div id="uploadPlaceholder">
                            ...
                            <p class="text-sm text-gray-500 mt-1">
                                <?php echo e($type->getAllowedExtensionsString()); ?> â€¢ Max <?php echo e($type->max_size_mb); ?>MB
                            </p>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="2"
                              class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500"
                              placeholder="Notes ou informations supplémentaires..."><?php echo e(old('description')); ?></textarea>
                </div>
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views\employee\documents\create.blade.php ENDPATH**/ ?>