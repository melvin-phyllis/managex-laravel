                    ...
                    <?php if(isset($payrollCountries) && $payrollCountries->count() > 0): ?>
                        <div class="mt-6 p-4 bg-emerald-50 rounded-lg max-w-md">
                            <p class="text-sm text-emerald-800">
                                ...
                                <a href="<?php echo e(route('admin.payroll-settings.countries')); ?>" class="underline hover:no-underline">Gérer les pays </a>
                            </p>
                        </div>
                    <?php else: ?>
                        <div class="mt-6 p-4 bg-yellow-50 rounded-lg max-w-md">
                            <p class="text-sm text-yellow-800">
                                ...
                                <a href="<?php echo e(route('admin.payroll-settings.countries')); ?>" class="underline hover:no-underline">Configurer un pays </a>
                            </p>
                        </div>
                    <?php endif; ?>
