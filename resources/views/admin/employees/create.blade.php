<x-layouts.admin>
    <div class="space-y-6" x-data="employeeForm()">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('admin.employees.index') }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-[#1B3C35] md:ml-2">Employés</a>
                    </div>
                </li>
        ...
        <!-- Info Box -->
        <div class="bg-[#F0F5F3] border border-[#B8D1C7] rounded-xl p-4 flex items-start space-x-3 animate-fade-in-up animation-delay-200">
            <svg class="w-5 h-5 text-[#1B3C35] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
            </svg>
            <div class="text-sm text-[#163530]">
        ...
        <form action="{{ route('admin.employees.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6 animate-fade-in-up animation-delay-300" @submit="sessionStorage.removeItem(DRAFT_KEY)">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 bg-gray-50 border-b border-gray-100">
                    <h2 class="text-lg font-semibold text-gray-900 flex items-center">
                        <svg class="w-5 h-5 mr-2 text-[#1B3C35]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <!-- Nom -->
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Nom complet <span class="text-[#2D5A4E]">*</span></label>
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required
                                   class="w-full rounded-lg border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E] @error('name') border-[#2D5A4E] @enderror"
                        ...
                        <!-- Email -->
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email <span class="text-[#2D5A4E]">*</span></label>
                            <input type="email" name="email" id="email" value="{{ old('email') }}" required
                                   class="w-full rounded-lg border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E] @error('email') border-[#2D5A4E] @enderror"
                        ...
                        <div>
                            ...
                            <input type="text" name="telephone" id="telephone" value="{{ old('telephone') }}"
                                   class="w-full rounded-lg border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E] @error('telephone') border-[#2D5A4E] @enderror"
                        ...
                        <div>
                            ...
                            <input type="date" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth') }}"
                                   class="w-full rounded-lg border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E] @error('date_of_birth') border-[#2D5A4E] @enderror">
                            @error('date_of_birth')
                                <p class="mt-1 text-sm text-[#1B3C35]">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <!-- Genre -->
                        <div>
                            <label for="gender" class="block text-sm font-medium text-gray-700 mb-1">Genre <span class="text-[#2D5A4E]">*</span></label>
                            <select name="gender" id="gender" required class="w-full rounded-lg border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E]">
                        ...
                        <div>
                            ...
                            <input type="file" name="avatar" id="avatar" accept="image/*"
                                   class="w-full rounded-lg border border-gray-300 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-[#F0F5F3] file:text-[#163530] hover:file:bg-[#E8F0ED] @error('avatar') border-[#2D5A4E] @enderror">
                            @error('avatar')
                                <p class="mt-1 text-sm text-[#1B3C35]">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <select name="country" id="country" class="w-full rounded-lg border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E]">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 bg-gray-50 border-b border-gray-100">
                    <h2 class="text-lg font-semibold text-gray-900 flex items-center">
                        <svg class="w-5 h-5 mr-2 text-[#C8A96E]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <!-- Département -->
                        <div>
                            <label for="department_id" class="block text-sm font-medium text-gray-700 mb-1">Département <span class="text-[#2D5A4E]">*</span></label>
                            ...
                            <a href="{{ route('admin.settings.index', ['tab' => 'organisation', 'from' => 'employee-create']) }}"
                               class="mt-1.5 inline-flex items-center gap-1 text-xs text-[#1B3C35] hover:text-[#163530] font-medium transition-colors">
                        ...
                        <div>
                            ...
                            <select name="position_id" id="position_id" x-model="positionId" :disabled="!departmentId"
                                    class="w-full rounded-lg border-gray-300 focus:border-[#2D5A4E] focus:ring-[#2D5A4E] disabled:bg-gray-100">
                        ...
                        <!-- Poste (libre) -->
                        <div>
                            <label for="poste" class="block text-sm font-medium text-gray-700 mb-1">Intitulé du poste <span class="text-[#2D5A4E]">*</span></label>
                        ...
                        <!-- Date d'embauche -->
                        <div>
                            <label for="hire_date" class="block text-sm font-medium text-gray-700 mb-1">Date d'embauche <span class="text-[#2D5A4E]">*</span></label>
                        ...
                        <!-- Type de contrat -->
                        <div>
                            <label for="contract_type" class="block text-sm font-medium text-gray-700 mb-1">Type de contrat <span class="text-[#2D5A4E]">*</span></label>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 bg-gray-50 border-b border-gray-100">
                    <h2 class="text-lg font-semibold text-gray-900 flex items-center">
                        ...
                        Jours de travail <span class="text-[#2D5A4E] ml-1">*</span>
                    </h2>
                </div>
                <div class="p-6">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        @foreach($days as $value => $label)
                            <label class="inline-flex items-center px-4 py-2 rounded-lg border border-gray-200 hover:bg-gray-50 cursor-pointer transition-colors has-[:checked]:bg-[#F0F5F3] has-[:checked]:border-[#8FB5A8]">
            ...
            <div class="flex items-center justify-end space-x-4 py-4">
                ...
                <button type="submit" class="px-6 py-2.5 bg-[#1B3C35] text-white font-medium rounded-lg hover:bg-[#163530] transition-colors flex items-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
