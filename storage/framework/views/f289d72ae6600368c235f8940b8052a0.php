...
<?php $component->withAttributes([]); ?>
    <div class="space-y-6">
        ...
        <div class="bg-blue-200 rounded-2xl p-6 text-black shadow-xl border border-gray-200">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-gray-600">Bienvenue, <?php echo e(auth()->user()->name); ?> - <?php echo e(now()->translatedFormat('l d F Y')); ?></p>
                </div>
            ...
            <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-5 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-1"><?php echo e($advancedStats['presence_rate']); ?>%</p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-red-500 to-rose-600 rounded-xl p-5 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-1"><?php echo e($advancedStats['absenteeism_rate']); ?>%</p>
                    </div>
                    <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-gradient-to-br from-emerald-500 to-green-600 rounded-xl p-5 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-1"><?php echo e($advancedStats['tasks_completed_this_week']); ?></p>
            ...
            <div class="bg-gradient-to-br from-violet-500 to-purple-600 rounded-xl p-5 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-1"><?php echo e($advancedStats['avg_hours_today']); ?>h</p>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            <a href="<?php echo e(route('admin.employees.index')); ?>" class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_employees']); ?></p>
                        <p class="text-xs text-gray-500">Employés</p>
                    </div>
                </div>
            </a>

            <a href="<?php echo e(route('admin.presences.index')); ?>" class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['presences_today']); ?></p>
                        <p class="text-xs text-gray-500">Présents</p>
                    </div>
                </div>
            </a>

            <a href="<?php echo e(route('admin.tasks.index', ['statut' => 'pending'])); ?>" class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div class="flex items-center gap-3">
            ...
            <a href="<?php echo e(route('admin.leaves.index', ['statut' => 'pending'])); ?>" class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['pending_leaves']); ?></p>
                        <p class="text-xs text-gray-500">Congés</p>
                    </div>
                </div>
            </a>

            <a href="<?php echo e(route('admin.surveys.index')); ?>" class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['active_surveys']); ?></p>
                       ...
                       class="flex items-center justify-between p-3 bg-amber-50 rounded-xl hover:bg-amber-100 transition-colors group">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500"><?php echo e($stats['pending_tasks']); ?> en attente</p>
                            </div>
                        </div>
                       ...
                       class="flex items-center justify-between p-3 bg-violet-50 rounded-xl hover:bg-violet-100 transition-colors group">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500"><?php echo e($stats['pending_leaves']); ?> demandes</p>
                            </div>
                        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-5 py-4 bg-gradient-to-r from-gray-50 to-slate-50 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('admin.tasks.index')); ?>" class="text-sm text-blue-600 hover:underline">Voir tout</a>
                </div>
                <div class="p-5 h-72">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-5 py-4 bg-gradient-to-r from-gray-50 to-slate-50 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('admin.presences.index')); ?>" class="text-sm text-blue-600 hover:underline">Voir tout</a>
                </div>
                <div class="p-5 h-72">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-5 py-4 bg-gradient-to-r from-gray-50 to-slate-50 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('admin.leaves.index')); ?>" class="text-sm text-blue-600 hover:underline">Voir tout</a>
                </div>
                <div class="p-5 h-72">
