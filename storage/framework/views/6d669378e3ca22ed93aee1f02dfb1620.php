...
<div <?php echo e($attributes->merge(['class' => 'bg-white rounded-xl shadow-sm border border-gray-100 p-6 animate-fade-in-up'])); ?>
     ...
     x-data="miniCalendar(<?php echo \Illuminate\Support\Js::from($events)->toHtml() ?>, <?php echo e($month); ?>, <?php echo e($year); ?>)">
...
<?php /**PATH D:\ManageX\resources\views\components\mini-calendar.blade.php ENDPATH**/ ?>