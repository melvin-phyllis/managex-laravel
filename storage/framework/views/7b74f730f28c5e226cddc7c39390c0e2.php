    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['pending_ack']); ?></p>
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total'] - $stats['unread']); ?></p>
        ...
        <div class="flex flex-wrap gap-2">
            <a href="<?php echo e(route('employee.announcements.index')); ?>" 
               class="px-4 py-2 rounded-lg font-medium transition-all <?php echo e($filter === 'all' ? 'bg-gradient-to-r from-indigo-600 to-blue-600 text-white shadow-md' : 'bg-white text-gray-700 hover:bg-gray-50 border border-gray-200'); ?>">
                Toutes (<?php echo e($stats['total']); ?>)
            </a>
            <a href="<?php echo e(route('employee.announcements.index', ['filter' => 'unread'])); ?>" 
               class="px-4 py-2 rounded-lg font-medium transition-all <?php echo e($filter === 'unread' ? 'bg-gradient-to-r from-indigo-600 to-blue-600 text-white shadow-md' : 'bg-white text-gray-700 hover:bg-gray-50 border border-gray-200'); ?>">
            ...
            <a href="<?php echo e(route('employee.announcements.index', ['filter' => 'acknowledgment'])); ?>" 
               class="px-4 py-2 rounded-lg font-medium transition-all <?php echo e($filter === 'acknowledgment' ? 'bg-gradient-to-r from-amber-500 to-orange-500 text-white shadow-md' : 'bg-amber-50 text-amber-700 hover:bg-amber-100 border border-amber-200'); ?>">
                é€ confirmer (<?php echo e($stats['pending_ack']); ?>)
            </a>
            <?php endif; ?>
        </div>
        ...
        <div class="space-y-4">
            <?php $__empty_1 = true; $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="bg-white rounded-xl shadow-sm border <?php echo e(!$announcement->is_read ? 'border-indigo-300 bg-indigo-50/30' : 'border-gray-100'); ?> overflow-hidden hover:shadow-md transition-all">
                    <div class="p-5">
                        <div class="flex flex-col sm:flex-row sm:items-start gap-4">
                            <!-- Icé´ne -->
                            <div class="flex-shrink-0 w-12 h-12 bg-gradient-to-br <?php echo e($typeColor); ?> rounded-xl flex items-center justify-center text-white shadow-sm">
