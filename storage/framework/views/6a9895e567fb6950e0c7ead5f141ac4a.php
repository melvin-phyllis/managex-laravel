    ...
    <div class="space-y-6" x-data="payrollTable()">
        ...
        <div class="flex items-center justify-between animate-fade-in-up">
            ...
            <div class="flex space-x-3">
                ...
                <a href="<?php echo e(route('admin.payrolls.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $payrolls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payroll): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-8 w-8">
                                            <?php if($payroll->user->avatar): ?>
                                                <img class="h-8 w-8 rounded-full object-cover" src="<?php echo e(avatar_url($payroll->user->avatar)); ?>" alt="<?php echo e($payroll->user->name); ?>">
                                            <?php else: ?>
                                                <div class="h-8 w-8 rounded-full bg-blue-100 flex items-center justify-center">
                                                    <span class="text-blue-600 font-medium text-xs"><?php echo e(strtoupper(substr($payroll->user->name, 0, 2))); ?></span>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        <div class="ml-3">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($payroll->periode); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
...
<?php endif; ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        <a href="<?php echo e(route('admin.payrolls.download', $payroll)); ?>" class="text-red-600 hover:text-red-900" title="Télécharger PDF">
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('admin.payrolls.edit', $payroll)); ?>" class="text-yellow-600 hover:text-yellow-900" title="Modifier">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views\admin\payrolls\index.blade.php ENDPATH**/ ?>