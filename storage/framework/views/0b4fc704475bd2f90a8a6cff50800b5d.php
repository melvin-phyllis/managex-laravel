                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="date_debut" id="date_debut" 
                                   ...
                                   class="w-full pl-10 rounded-lg border-gray-300 focus:border-teal-500 focus:ring-teal-500 <?php $__errorArgs = ['date_debut'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="date_fin" id="date_fin" 
                                   ...
                                   required 
                                   min="<?php echo e(now()->format('Y-m-d')); ?>" 
                                   class="w-full pl-10 rounded-lg border-gray-300 focus:border-teal-500 focus:ring-teal-500 <?php $__errorArgs = ['date_fin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="motif" id="motif" rows="4" required 
                              class="w-full rounded-lg border-gray-300 focus:border-teal-500 focus:ring-teal-500 <?php $__errorArgs = ['motif'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
