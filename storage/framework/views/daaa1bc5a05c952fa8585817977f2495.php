...
unset($__errorArgs, $__bag); ?>" placeholder="Ex: Préparer le rapport mensuel">
...
unset($__errorArgs, $__bag); ?>" placeholder="Décrivez la tâche en détail..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" name="date_debut" id="date_debut" value="<?php echo e(old('date_debut', now()->format('Y-m-d'))); ?>" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 <?php $__errorArgs = ['date_debut'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" name="date_fin" id="date_fin" value="<?php echo e(old('date_fin')); ?>" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 <?php $__errorArgs = ['date_fin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views\admin\tasks\create.blade.php ENDPATH**/ ?>