...
<?php $component->withAttributes([]); ?>
                        ...
                        <div>
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-blue-100 text-sm mt-0.5"><?php echo e($geolocationZone->name); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        ...
        <form action="<?php echo e(route('admin.geolocation-zones.update', $geolocationZone)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>

            <!-- Champs cachés pour les coordonnées -->
            <input type="hidden" name="latitude" id="latitude" value="<?php echo e(old('latitude', $geolocationZone->latitude)); ?>">
            <input type="hidden" name="longitude" id="longitude" value="<?php echo e(old('longitude', $geolocationZone->longitude)); ?>">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-5 space-y-5">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="<?php echo e(old('name', $geolocationZone->name)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="2"
                                          class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors"
                                          placeholder="Description optionnelle de cette zone..."><?php echo e(old('description', $geolocationZone->description)); ?></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="address" id="address" value="<?php echo e(old('address', $geolocationZone->address)); ?>" readonly
                            ...
                            <div>
                                <label for="radius" class="block text-sm font-medium text-gray-700 mb-1.5">
                                    Rayon de la zone : <span id="radiusValue" class="font-bold" style="color: #5680E9;"><?php echo e($geolocationZone->radius); ?></span> mètres
                                </label>
                                <input type="range" name="radius" id="radius" value="<?php echo e(old('radius', $geolocationZone->radius)); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="p-3 rounded-lg border border-gray-100" style="background: linear-gradient(90deg, #5680E910, #84CEEB10);">
                                ...
                                <p class="text-sm font-mono text-gray-700">
                                    <span id="coordsDisplay"><?php echo e($geolocationZone->latitude); ?>, <?php echo e($geolocationZone->longitude); ?></span>
                                </p>
                            </div>
                            ...
                            <div class="space-y-3 pt-2">
                                <label class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                                    <input type="checkbox" name="is_active" id="is_active" value="1"
                                           <?php echo e(old('is_active', $geolocationZone->is_active) ? 'checked' : ''); ?>
                                ...
                                <label class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                                    <input type="checkbox" name="is_default" id="is_default" value="1"
                                           <?php echo e(old('is_default', $geolocationZone->is_default) ? 'checked' : ''); ?>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="hidden lg:flex justify-between items-center px-5 py-4 bg-gray-50 border-t border-gray-100">
                            <div class="text-sm text-gray-500">
                                ...
                                <?php echo e($geolocationZone->updated_at->format('d/m/Y é  H:i')); ?>
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views/admin/geolocation-zones/edit.blade.php ENDPATH**/ ?>