<x-layouts.admin>
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <!-- Form -->
        <form action="{{ route('admin.global-documents.update', $globalDocument) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          class="w-full rounded-lg border-gray-300 focus:border-emerald-500 focus:ring-emerald-500">{{ old('description', $globalDocument->description) }}</textarea>
            </div>
            ...
            <div class="p-4 bg-gray-50 rounded-lg">
                ...
                <div class="flex items-center gap-3">
                    <span class="text-xl">{{ $globalDocument->file_icon }}</span>
