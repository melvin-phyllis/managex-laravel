...
<body>
    ...
    <nav class="nav">
        ...
        <div style="display: flex; align-items: center; gap: 1rem;">
            <a href="<?php echo e(url('/')); ?>" style="color: var(--text-muted); text-decoration: none; font-weight: 500; display: none; @media(min-width:768px){display:block;}">Retour</a>
        ...
        <div class="container">
            ...
            <div class="form-card" x-data="{ submitting: false }">
                ...
                <div class="success-overlay">
                    ...
                    <a href="<?php echo e(url('/')); ?>" class="cta-button" style="display: inline-block;">Retour à l'accueil</a>
                </div>
                <?php endif; ?>
                ...
                <form action="<?php echo e(route('demo-request.store')); ?>" method="POST" @submit="submitting = true">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="contact_name" class="form-input" placeholder="Jean Dupont" required value="<?php echo e(old('contact_name')); ?>">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Email Pro</label>
                            <input type="email" name="email" class="form-input" placeholder="jean@entreprise.com" required value="<?php echo e(old('email')); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="company_name" class="form-input" placeholder="Tech Solutions" required value="<?php echo e(old('company_name')); ?>">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="phone" class="form-input" placeholder="+225 07 00 00 00" value="<?php echo e(old('phone')); ?>">
                    </div>

                    <div class="form-group">
                        <label class="form-label">Message (Optionnel)</label>
                        <textarea name="message" class="form-textarea" rows="3" placeholder="Vos besoins spécifiques..."><?php echo e(old('message')); ?></textarea>
                    </div>
...
<?php /**PATH D:\ManageX\resources\views/demo-request.blade.php ENDPATH**/ ?>