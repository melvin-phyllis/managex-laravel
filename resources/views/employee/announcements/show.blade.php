<x-layouts.employee>
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            <!-- Header Section -->
            <div class="relative p-8" style="background-color: #1B3C35;">
                <!-- Decorative elements -->
            ...
            @if($announcement->requires_acknowledgment)
                <div class="px-8 pb-8">
                    @if($announcement->is_acknowledged)
                        <div class="p-6 rounded-2xl" style="background: linear-gradient(135deg, rgba(27, 60, 53, 0.1) 0%, rgba(196, 219, 246, 0.3) 100%); border: 1px solid rgba(27, 60, 53, 0.2);">
                            <div class="flex items-center gap-4">
                                <div class="w-14 h-14 rounded-xl flex items-center justify-center" style="background-color: #1B3C35;">
                                    <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/>
                                    </svg>
                                </div>
                                <div class="flex-1">
                                    <p class="font-semibold text-lg" style="color: #1B3C35;">Accusé de réception envoyé</p>
                                    <p class="text-sm" style="color: #5C6E68;">Vous avez confirmé avoir pris connaissance de cette annonce.</p>
                                </div>
                    ...
                    @else
                        <div class="p-6 rounded-2xl" style="background: linear-gradient(135deg, #E7E3D4 0%, rgba(231, 227, 212, 0.5) 100%); border: 1px solid rgba(133, 144, 170, 0.2);">
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                <div class="flex items-center gap-4">
                                    <div class="w-14 h-14 rounded-xl flex items-center justify-center" style="background-color: #5C6E68;">
                                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm" style="color: #5C6E68;">Veuillez confirmer avoir lu cette annonce importante.</p>
                                    </div>
                                </div>
