                        ...
                        <div>
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-[#B8D1C7] text-sm mt-0.5">Définissez une zone géographique pour le pointage</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        ...
        <div class="mb-6 border rounded-xl p-4" style="background: linear-gradient(90deg, #1B3C3520, #3D7A6A10); border-color: #1B3C3540;">
            <div class="flex items-start gap-3">
                ...
                <div>
                    <h3 class="font-semibold" style="color: #1B3C35;">Comment créer une zone ?</h3>
                        ...
                        <div class="p-5 space-y-5">
                            ...
                            <div>
                                <label for="radius" class="block text-sm font-medium text-gray-700 mb-1.5">
                                    Rayon de la zone : <span id="radiusValue" class="font-bold" style="color: #1B3C35;">100</span> mètres
                                </label>
                ...
                try {
                    ...
                    if (data.length > 0) {
                        ...
                        searchResults.innerHTML = data.map((item, index) => `
                            <div class="p-3 hover:bg-[#F0F5F3] cursor-pointer border-b last:border-b-0 transition"
