{{-- 
    ...
    À inclure une seule fois dans le layout principal
--}}
...
<div x-data="downloadManager()" 
    ...
    {{-- Overlay sombre avec modal de progression --}}
    <div x-show="isDownloading"
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8 max-w-sm w-full mx-4 text-center">
            ...
            {{-- Bouton fermer (uniquement après succès/erreur) --}}
