...
<?php $component->withAttributes([]); ?>
    <div class="space-y-6">
                    ...
                    <div>
                        <nav class="flex mb-3" aria-label="Breadcrumb">
                            <ol class="inline-flex items-center space-x-1">
                                ...
                                <li><span class="text-white/50 mx-2">/</span></li>
                                <li><span class="text-white/70 text-sm"><?php echo e($country->name); ?></span></li>
                                <li><span class="text-white/50 mx-2">/</span></li>
                        ...
                        <h1 class="text-2xl md:text-3xl font-bold text-white flex items-center gap-3">
                            ...
                            Règles de Calcul - <?php echo e($country->name); ?>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-purple-50/50 transition-colors group">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    ?>
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium" style="<?php echo e($typeColors[$rule->rule_type] ?? 'background-color: rgba(156, 163, 175, 0.15); color: #6b7280;'); ?>">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                    <?php if($rule->calculation_type === 'percentage'): ?>
                                        <span style="color: #5680E9;"><?php echo e(number_format($rule->rate, 2)); ?>%</span>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php if($rule->rule_category === 'employee'): ?>
                                    ...
                                    <?php elseif($rule->rule_category === 'employer'): ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <a href="<?php echo e(route('admin.payroll-settings.rules.edit', [$country, $rule])); ?>" class="p-1.5 text-gray-500 hover:text-amber-600 hover:bg-amber-50 rounded-lg transition-colors" title="Modifier">
        ...
        <div class="flex justify-start">
            <a href="<?php echo e(route('admin.payroll-settings.countries')); ?>" class="inline-flex items-center px-4 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors">
