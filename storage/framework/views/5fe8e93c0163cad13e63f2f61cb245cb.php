...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table-header','data' => ['title' => 'Évaluation de '.e($intern->name).'','subtitle' => ''.e(now()->startOfWeek()->format('d/m/Y')).' - Semaine en cours']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Évaluation de '.e($intern->name).'','subtitle' => ''.e(now()->startOfWeek()->format('d/m/Y')).' - Semaine en cours']); ?>
...
<?php endif; ?>
        ...
        <form action="<?php echo e(route($routePrefix . '.store', $intern)); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="mb-4">
                            <input type="range" 
                                   ...
                                   value="<?php echo e(old($key.'_score', $evaluation->{$key.'_score'} ?? 0)); ?>"
                        ...
                        <textarea name="<?php echo e($key); ?>_comment" 
                                  ...
                                  placeholder="Commentaire sur <?php echo e(strtolower($criterion['label'])); ?>..."><?php echo e(old($key.'_comment', $evaluation->{$key.'_comment'})); ?></textarea>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 space-y-4">
                ...
                <div>
                    ...
                    <textarea name="general_comment" 
                              rows="4" 
                              class="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-violet-500 focus:border-violet-500 resize-none"
                              placeholder="Résumé global de la performance cette semaine..."><?php echo e(old('general_comment', $evaluation->general_comment)); ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="objectives_next_week" 
                              rows="3" 
                              class="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-violet-500 focus:border-violet-500 resize-none"
                              placeholder="Points à améliorer, objectifs à atteindre..."><?php echo e(old('objectives_next_week', $evaluation->objectives_next_week)); ?></textarea>
                </div>
            </div>
...
<?php endif; ?>
                ...
                <div class="flex gap-3">
                    <button type="submit" name="action" value="draft" class="px-6 py-2.5 bg-gray-100 text-gray-700 rounded-xl font-medium hover:bg-gray-200 transition-colors">
                        <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'save','class' => 'w-4 h-4 inline mr-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'save','class' => 'w-4 h-4 inline mr-1']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
                    ...
                    <button type="submit" name="action" value="submit" class="px-6 py-2.5 bg-violet-600 text-white rounded-xl font-medium hover:bg-violet-700 transition-colors">
                        <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'send','class' => 'w-4 h-4 inline mr-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'send','class' => 'w-4 h-4 inline mr-1']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
        ...
        <?php if($previousEvaluations->isNotEmpty()): ?>
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__currentLoopData = $previousEvaluations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="px-4 py-2"><?php echo e($prev->week_label); ?></td>
                                    <td class="px-4 py-2 text-center"><?php echo e($prev->discipline_score); ?></td>
                                    <td class="px-4 py-2 text-center"><?php echo e($prev->behavior_score); ?></td>
                                    <td class="px-4 py-2 text-center"><?php echo e($prev->skills_score); ?></td>
                                    <td class="px-4 py-2 text-center"><?php echo e($prev->communication_score); ?></td>
                                    <td class="px-4 py-2 text-center font-semibold"><?php echo e($prev->total_score); ?>/10</td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
...
<?php /**PATH D:\ManageX\resources\views\tutor\evaluations\create.blade.php ENDPATH**/ ?>