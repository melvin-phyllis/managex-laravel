                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                            ...
                            <div class="grid grid-cols-3 gap-px bg-gray-100">
                                ...
                                <div class="bg-white p-3 text-center">
                                    ...
                                    <p class="text-sm font-semibold" style="color: #8860D0;"><?php echo e($zone->radius); ?> m</p>
                                </div>
                                <div class="bg-white p-3 text-center">
                                    <p class="text-xs text-gray-500 mb-1">Pointages</p>
                                    <p class="text-sm font-semibold" style="color: #5680E9;"><?php echo e($zone->presences_count); ?></p>
                                </div>
                            </div>
