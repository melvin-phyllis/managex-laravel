                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @foreach($payrolls as $payroll)
                                @php
                                    $statusConfig = [
                                        'draft' => ['bg' => '#E7E3D4', 'text' => '#5C6E68', 'label' => 'Brouillon'],
                                        'pending' => ['bg' => '#E7E3D4', 'text' => '#5C6E68', 'label' => 'En attente'],
                                        'paid' => ['bg' => 'rgba(27, 60, 53, 0.15)', 'text' => '#1B3C35', 'label' => 'Payé'],
                                        'cancelled' => ['bg' => 'rgba(200, 169, 110, 0.15)', 'text' => '#C8A96E', 'label' => 'Annulé'],
                                    ];
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <p class="text-lg font-bold" style="color: #1B3C35;">{{ number_format($payroll->net_a_payer, 0, ',', ' ') }} FCFA</p>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <a href="{{ route('employee.payrolls.download', $payroll) }}" 
                                           class="inline-flex items-center gap-2 px-4 py-2 text-white rounded-lg transition-all shadow-sm text-sm font-medium" style="background-color: #C8A96E;">
                        ...
                        <div class="p-4">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-semibold text-gray-900">{{ $payroll->periode }}</p>
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium" style="background-color: {{ $status['bg'] }}; color: {{ $status['text'] }};">
                                            {{ $status['label'] }}
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('employee.payrolls.download', $payroll) }}" 
                                   class="inline-flex items-center gap-2 px-4 py-2 text-white rounded-lg text-sm font-medium" style="background-color: #C8A96E;">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                                    </svg>
                                    PDF
