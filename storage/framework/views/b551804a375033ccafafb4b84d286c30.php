            ...
            <div class="relative p-6 md:p-8">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                        ...
                        <div>
                            <p class="text-white font-medium text-sm"><?php echo e(auth()->user()->name); ?></p>
        ...
        <div x-show="activeTab === 'compte'" x-cloak>
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <form action="<?php echo e(route('admin.settings.update-email')); ?>" method="POST" class="p-6">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="email" id="current_email" value="<?php echo e(auth()->user()->email); ?>" disabled
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <form action="<?php echo e(route('admin.settings.update-password')); ?>" method="POST" class="p-6">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl">
                        <div>
                            ...
                            <input type="time" name="work_start_time" id="work_start_time"
                                   value="<?php echo e(old('work_start_time', $settings['work_start_time'])); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="time" name="work_end_time" id="work_end_time"
                                   value="<?php echo e(old('work_end_time', $settings['work_end_time'])); ?>"
                                   class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500 text-lg py-3">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-6 p-4 bg-green-50 rounded-lg max-w-2xl">
                        <p class="text-sm text-green-800">
                            ...
                            <span class="font-mono"><?php echo e($settings['work_start_time']); ?></span> é 
                            <span class="font-mono"><?php echo e($settings['work_end_time']); ?></span>
                        </p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl">
                        <div>
                            ...
                            <input type="time" name="break_start_time" id="break_start_time"
                                   value="<?php echo e(old('break_start_time', $settings['break_start_time'])); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="time" name="break_end_time" id="break_end_time"
                                   value="<?php echo e(old('break_end_time', $settings['break_end_time'])); ?>"
                                   class="w-full rounded-lg border-gray-300 focus:border-orange-500 focus:ring-orange-500 text-lg py-3">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-6 p-4 bg-orange-50 rounded-lg max-w-2xl">
                        <p class="text-sm text-orange-800">
                            ...
                            <span class="font-mono"><?php echo e($settings['break_start_time']); ?></span> é 
                            <span class="font-mono"><?php echo e($settings['break_end_time']); ?></span>
        ...
        <div x-show="activeTab === 'retards'" x-cloak>
            <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="max-w-md" x-data="{ tolerance: <?php echo e($settings['late_tolerance_minutes']); ?> }">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-6 p-4 bg-red-50 rounded-lg max-w-md">
                        <p class="text-sm text-red-800">
                            <strong>Exemple :</strong> Avec une tolérance de <?php echo e($settings['late_tolerance_minutes']); ?> min et un début é  <?php echo e($settings['work_start_time']); ?>,
                        ...
                        <div class="border border-gray-200 rounded-lg overflow-hidden" x-data="{ open: false }">
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50 cursor-pointer hover:bg-gray-100 transition-colors" @click="open = !open">
                                <div class="flex items-center gap-3">
                                    <div class="w-4 h-4 rounded-full" style="background-color: <?php echo e($department->color); ?>"></div>
                                    <div>
                                        <h3 class="font-medium text-gray-900"><?php echo e($department->name); ?></h3>
                                        <p class="text-sm text-gray-500">
                                            <?php echo e($department->positions_count); ?> poste(s) Â· <?php echo e($department->users_count); ?> employé(s)
                                        </p>
                                    </div>
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="button" @click.stop="openEditDepartment(<?php echo e($department->id); ?>, '<?php echo e(addslashes($department->name)); ?>', '<?php echo e(addslashes($department->description ?? '')); ?>', '<?php echo e($department->color); ?>', <?php echo e($department->is_active ? 'true' : 'false'); ?>)"
                                    ...
                                    <?php if($department->users_count == 0): ?>
                                        <form action="<?php echo e(route('admin.settings.departments.destroy', $department)); ?>" method="POST" class="inline" onsubmit="return confirm('Supprimer ce département ?')">
                                            <?php echo csrf_field(); ?>
                            ...
                            <div x-show="open" x-collapse>
                                <div class="p-4 border-t border-gray-200 bg-white">
                                    <?php if($department->description): ?>
                                        <p class="text-sm text-gray-600 mb-4"><?php echo e($department->description); ?></p>
                                    <?php endif; ?>

                                    <div class="flex items-center justify-between mb-3">
                                        <h4 class="text-sm font-medium text-gray-700">Postes</h4>
                                        <button type="button" @click.stop="openCreatePosition(<?php echo e($department->id); ?>, '<?php echo e(addslashes($department->name)); ?>')"
                                    ...
                                    <?php if($department->positions->count() > 0): ?>
                                        <div class="space-y-2">
                                            <?php $__currentLoopData = $department->positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                                    <div>
                                                        <span class="font-medium text-gray-900"><?php echo e($position->name); ?></span>
                                                        <?php if($position->description): ?>
                                                            <p class="text-xs text-gray-500"><?php echo e($position->description); ?></p>
                                                        <?php endif; ?>
                                                        <span class="text-xs text-gray-400"><?php echo e($position->users_count ?? 0); ?> employé(s)</span>
                                                    </div>
                                                    <div class="flex items-center gap-1">
                                                        ...
                                                        <?php endif; ?>
                                                        <button type="button" @click.stop="openEditPosition(<?php echo e($position->id); ?>, <?php echo e($department->id); ?>, '<?php echo e(addslashes($position->name)); ?>', '<?php echo e(addslashes($position->description ?? '')); ?>', <?php echo e($position->is_active ? 'true' : 'false'); ?>)"
                                                                class="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded transition-colors">
                                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                            </svg>
                                                        </button>
                                                        <?php if(($position->users_count ?? 0) == 0): ?>
                                                            <form action="<?php echo e(route('admin.settings.positions.destroy', $position)); ?>" method="POST" class="inline" onsubmit="return confirm('Supprimer ce poste ?')">
                                                                <?php echo csrf_field(); ?>
                                                                <?php echo method_field('DELETE'); ?>
        ...
        <div x-show="showDepartmentModal" x-cloak class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-show="showDepartmentModal" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0 sm:scale-100" x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                    <form :action="editingDepartment ? '<?php echo e(url('admin/settings/departments')); ?>/' + editingDepartment : '<?php echo e(route('admin.settings.departments.store')); ?>'" method="POST">
                        <?php echo csrf_field(); ?>
        ...
        <div x-show="showPositionModal" x-cloak class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-show="showPositionModal" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0 sm:scale-100" x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                    <form :action="editingPosition ? '<?php echo e(url('admin/settings/positions')); ?>/' + editingPosition : '<?php echo e(route('admin.settings.positions.store')); ?>'" method="POST">
                        <?php echo csrf_field(); ?>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="max-w-md">
                        ...
                        <select name="payroll_country_id" id="payroll_country_id"
                            ...
                            <?php $__currentLoopData = $payrollCountries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($country->id); ?>" <?php echo e(($settings['payroll_country_id'] ?? null) == $country->id ? 'selected' : ''); ?>>
                                    <?php echo e($country->name); ?> (<?php echo e($country->currency_symbol); ?>)
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php $__errorArgs = ['payroll_country_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if(isset($payrollCountries) && $payrollCountries->count() > 0): ?>
                        <div class="mt-6 p-4 bg-emerald-50 rounded-lg max-w-md">
                            <p class="text-sm text-emerald-800">
                                <strong><?php echo e($payrollCountries->count()); ?> pays configuré(s)</strong> dans le systéme.
                                <a href="<?php echo e(route('admin.payroll-settings.countries')); ?>" class="underline hover:no-underline">Gérer les pays â†’</a>
                            </p>
                        </div>
                    <?php else: ?>
                        <div class="mt-6 p-4 bg-yellow-50 rounded-lg max-w-md">
                            <p class="text-sm text-yellow-800">
                                ...
                                <a href="<?php echo e(route('admin.payroll-settings.countries')); ?>" class="underline hover:no-underline">Configurer un pays â†’</a>
                            </p>
                        </div>
                    <?php endif; ?>
    ...
    <script nonce="<?php echo e($cspNonce ?? ''); ?>">
        function settingsPage() {
            return {
                activeTab: '<?php echo e(request('tab', 'compte')); ?>',
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views\admin\settings\index.blade.php ENDPATH**/ ?>