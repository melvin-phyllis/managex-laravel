        ...
        <div class="border-b border-gray-200 animate-fade-in-up animation-delay-100" x-data="{ activeTab: 'security' }">
            ...
            <div x-show="activeTab === 'security'" x-cloak class="py-6">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <form action="<?php echo e(route('employee.settings.password')); ?>" method="POST" class="max-w-md">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">Connecté depuis <?php echo e(request()->ip()); ?></p>
                                </div>
                            </div>
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views/employee/settings/index.blade.php ENDPATH**/ ?>