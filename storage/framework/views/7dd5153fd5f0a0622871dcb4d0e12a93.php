...
<?php $component->withAttributes([]); ?>
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 animate-fade-in-up animation-delay-200">
            <form action="<?php echo e(route('admin.tasks.update', $task)); ?>" method="POST" class="p-6 space-y-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($employee->id); ?>" <?php echo e(old('user_id', $task->user_id) == $employee->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="titre" id="titre" value="<?php echo e(old('titre', $task->titre)); ?>" required class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 <?php $__errorArgs = ['titre'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="4" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="priorite" id="priorite" required class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 <?php $__errorArgs = ['priorite'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            <option value="low" <?php echo e(old('priorite', $task->priorite) === 'low' ? 'selected' : ''); ?>>Basse</option>
                            <option value="medium" <?php echo e(old('priorite', $task->priorite) === 'medium' ? 'selected' : ''); ?>>Moyenne</option>
                            <option value="high" <?php echo e(old('priorite', $task->priorite) === 'high' ? 'selected' : ''); ?>>Haute</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>">
                            <option value="pending" <?php echo e(old('statut', $task->statut) === 'pending' ? 'selected' : ''); ?>>En attente</option>
                            <option value="approved" <?php echo e(old('statut', $task->statut) === 'approved' ? 'selected' : ''); ?>>En cours</option>
                            <option value="completed" <?php echo e(old('statut', $task->statut) === 'completed' ? 'selected' : ''); ?>>Terminée (à valider)</option>
                            <option value="validated" <?php echo e(old('statut', $task->statut) === 'validated' ? 'selected' : ''); ?>>Validée</option>
                            <option value="rejected" <?php echo e(old('statut', $task->statut) === 'rejected' ? 'selected' : ''); ?>>Rejetée</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" name="date_debut" id="date_debut" value="<?php echo e(old('date_debut', $task->date_debut?->format('Y-m-d'))); ?>" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 <?php $__errorArgs = ['date_debut'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" name="date_fin" id="date_fin" value="<?php echo e(old('date_fin', $task->date_fin?->format('Y-m-d'))); ?>" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 <?php $__errorArgs = ['date_fin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="flex-1 bg-gray-200 rounded-full h-3">
                                <div class="bg-blue-600 h-3 rounded-full" style="width: <?php echo e($task->progression); ?>%"></div>
                            </div>
                            <span class="text-sm font-medium text-gray-700"><?php echo e($task->progression); ?>%</span>
                        </div>
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views\admin\tasks\edit.blade.php ENDPATH**/ ?>