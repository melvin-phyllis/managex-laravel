                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="message" rows="4" 
                                  ...
                                  class="w-full rounded-xl border-gray-200 py-3 px-4 focus:border-[#3B8BEB] focus:ring-[#3B8BEB] bg-gray-50 hover:bg-gray-100 transition-colors resize-none"><?php echo e(old('message')); ?></textarea>
                    </div>
