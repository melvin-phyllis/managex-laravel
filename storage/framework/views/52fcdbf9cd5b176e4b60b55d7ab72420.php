                    ...
                    <div>
                        <nav class="flex mb-3" aria-label="Breadcrumb">
                            <ol class="inline-flex items-center space-x-1">
                                ...
                                <li><a href="<?php echo e(route('admin.employees.index')); ?>" class="text-white/70 hover:text-white text-sm">Employés</a></li>
                                <li><span class="text-white/50 mx-2">/</span></li>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-3 flex items-center space-x-6 pb-4 border-b border-gray-100">
                            <?php if($employee->avatar): ?>
                                <img src="<?php echo e(avatar_url($employee->avatar)); ?>" alt="<?php echo e($employee->name); ?>" class="w-20 h-20 rounded-xl object-cover border-4 border-white shadow-lg">
                            <?php else: ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="<?php echo e(old('name', $employee->name)); ?>" required
                                   class="w-full rounded-xl border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" value="<?php echo e(old('email', $employee->email)); ?>" required
                                   class="w-full rounded-xl border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="password" name="password" id="password"
                                   class="w-full rounded-xl border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <select name="emergency_contact_relationship" id="emergency_contact_relationship"
                                ...
                                <option value="Frère/Sœur" <?php echo e(old('emergency_contact_relationship', $employee->emergency_contact_relationship) == 'Frère/Sœur' ? 'selected' : ''); ?>>Frère/Sœur</option>
