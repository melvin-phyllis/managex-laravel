...
<?php endif; ?>
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('admin.surveys.results', $survey)); ?>" class="inline-flex items-center px-4 py-2.5 text-white text-sm font-medium rounded-xl transition-colors shadow-lg" style="background: linear-gradient(135deg, #5AB9EA, #84CEEB); box-shadow: 0 10px 15px -3px rgba(90, 185, 234, 0.25);" onmouseover="this.style.filter='brightness(1.1)'" onmouseout="this.style.filter=''">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
