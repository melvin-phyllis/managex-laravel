<x-layouts.admin>
    <div class="min-h-screen">
        <!-- Header -->
        <div class="rounded-2xl lg:rounded-3xl mx-4 sm:mx-6 lg:mx-8 mt-4 sm:mt-6 p-6 sm:p-8 text-white shadow-xl relative overflow-hidden" style="background: linear-gradient(135deg, #1B3C35, #3D7A6A);">
            <!-- Decorative elements -->
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                ...
                                <p class="text-[#B8D1C7] text-sm sm:text-base mt-1">Gérez les périmètres autorisés pour le pointage</p>
                            </div>
                        </div>
                    </div>
                    <a href="{{ route('admin.geolocation-zones.create') }}" 
                       class="inline-flex items-center justify-center gap-2 px-5 py-3 bg-white font-semibold rounded-xl hover:bg-[#F0F5F3] transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5" style="color: #1B3C35;">
                    ...
                    <div class="bg-white/15 backdrop-blur-sm rounded-xl p-3 sm:p-4">
                        <div class="flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-[#B8D1C7]">Zones</p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white/15 backdrop-blur-sm rounded-xl p-3 sm:p-4">
                        <div class="flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-[#B8D1C7]">Actives</p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white/15 backdrop-blur-sm rounded-xl p-3 sm:p-4">
                        <div class="flex items-center gap-2 sm:gap-3">
                            <div class="p-2 rounded-lg" style="background-color: rgba(200, 169, 110, 0.3);">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-[#B8D1C7]">Par défaut</p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white/15 backdrop-blur-sm rounded-xl p-3 sm:p-4">
                        <div class="flex items-center gap-2 sm:gap-3">
                            <div class="p-2 bg-[#3D7A6A]/30 rounded-lg">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-[#B8D1C7]">Pointages</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="px-4 sm:px-6 lg:px-8 py-6">
            <!-- Info box -->
            <div class="border rounded-xl p-4 mb-6" style="background: linear-gradient(90deg, #1B3C3520, #3D7A6A10); border-color: #1B3C3540;">
                <div class="flex gap-3">
                    ...
                    <div>
                        <h3 class="text-sm font-semibold" style="color: #1B3C35;">Comment ça fonctionne ?</h3>
                        <p class="text-sm mt-1" style="color: #1B3C35CC;">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="p-2 rounded-xl" style="background-color: #1B3C3520;">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-sm font-medium" style="background-color: #C8A96E20; color: #C8A96E;">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-sm font-medium" style="background-color: #1B3C3520; color: #1B3C35;">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                            </svg>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <a href="{{ route('admin.geolocation-zones.edit', $zone) }}"
                                               class="p-2 text-[#2D5A4E] hover:text-[#163530] hover:bg-[#F0F5F3] rounded-lg transition-colors"
                                               title="Modifier">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                            ...
                            <div class="p-4 border-b border-gray-100">
                                <div class="flex items-start justify-between">
                                    <div class="flex items-center gap-3">
                                        <div class="p-2.5 rounded-xl shadow-lg" style="background: linear-gradient(135deg, #1B3C35, #3D7A6A);">
                            ...
                            <div class="grid grid-cols-3 gap-px bg-gray-100">
                                ...
                                <div class="bg-white p-3 text-center">
                                    ...
                                    <p class="text-sm font-semibold" style="color: #C8A96E;">{{ $zone->radius }} m</p>
                                </div>
                                <div class="bg-white p-3 text-center">
                                    <p class="text-xs text-gray-500 mb-1">Pointages</p>
                                    <p class="text-sm font-semibold" style="color: #1B3C35;">{{ $zone->presences_count }}</p>
                                </div>
                            </div>
                            ...
                            <div class="p-3 bg-gray-50 flex items-center justify-between gap-2">
                                <div class="flex items-center gap-2">
                                    ...
                                    <a href="{{ route('admin.geolocation-zones.edit', $zone) }}"
                                       class="flex items-center gap-1.5 px-3 py-2 text-white text-sm font-medium rounded-lg transition-colors" style="background: linear-gradient(135deg, #1B3C35, #2D5A4E);">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                        </svg>
                                        Modifier
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <form action="{{ route('admin.geolocation-zones.destroy', $zone) }}" method="POST"
                                        ...
                                        @method('DELETE')
                                        <button type="submit"
                                                class="p-2 text-[#1B3C35] hover:bg-[#F0F5F3] rounded-lg transition-colors"
                                                title="Supprimer">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                                            </svg>
            ...
            @else
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 sm:p-12 text-center">
                    <div class="max-w-md mx-auto">
                        <div class="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6" style="background: linear-gradient(135deg, #1B3C3520, #3D7A6A20);">
                        ...
                        <a href="{{ route('admin.geolocation-zones.create') }}" 
                           class="inline-flex items-center gap-2 px-6 py-3 text-white font-semibold rounded-xl transition-all shadow-lg hover:shadow-xl" style="background: linear-gradient(135deg, #1B3C35, #3D7A6A);">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                            </svg>
