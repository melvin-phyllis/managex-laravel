    ...
    <div class="space-y-6" x-data="announcementManagement()">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
            <form method="GET" class="flex flex-wrap gap-4">
                ...
                <select name="type" class="rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500">
                    ...
                    <option value="info" <?php echo e(request('type') === 'info' ? 'selected' : ''); ?>>â„¹ï¸ Info</option>
                    <option value="success" <?php echo e(request('type') === 'success' ? 'selected' : ''); ?>>âœ… Succés</option>
                    <option value="warning" <?php echo e(request('type') === 'warning' ? 'selected' : ''); ?>>âš ï¸ Attention</option>
                    <option value="urgent" <?php echo e(request('type') === 'urgent' ? 'selected' : ''); ?>>ðŸš Urgent</option>
                    <option value="event" <?php echo e(request('type') === 'event' ? 'selected' : ''); ?>>ðŸ“… événement</option>
                </select>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <?php $__empty_1 = true; $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="p-4 border-b border-gray-100 hover:bg-gray-50 transition-colors <?php echo e(!$announcement->is_active ? 'opacity-60' : ''); ?>">
                    <div class="flex items-start gap-4">
                        <!-- Icon -->
                        <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center
                            <?php if($announcement->type === 'urgent'): ?> bg-red-100
                            <?php elseif($announcement->type === 'warning'): ?> bg-amber-100
                            <?php elseif($announcement->type === 'success'): ?> bg-green-100
                            <?php elseif($announcement->type === 'event'): ?> bg-purple-100
                            ...
                            <div class="mt-2 flex items-center gap-2">
                                <div class="flex-1 max-w-xs h-2 bg-gray-200 rounded-full overflow-hidden">
                                    <div class="h-full bg-green-500 rounded-full" 
                                         style="width: <?php echo e($announcement->read_percentage); ?>%"></div>
                                </div>
