        ...
        <div class="bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-600 rounded-2xl p-6 text-white shadow-xl">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-violet-100">Semaine du <?php echo e(now()->startOfWeek()->format('d/m/Y')); ?> au <?php echo e(now()->endOfWeek()->format('d/m/Y')); ?></p>
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-emerald-600"><?php echo e($stats['evaluated_this_week']); ?></p>
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views\tutor\evaluations\index.blade.php ENDPATH**/ ?>