...
Route::get('/manifest.webmanifest', function () {
    return response()->json([
        ...
        'screenshots' => [
            [
                'src' => '/managex/public/screenshots/mobile-dashboard.png',
                'sizes' => '1080x1920',
                'type' => 'image/png',
                'form_factor' => 'narrow',
                'label' => 'Tableau de bord ManageX',
            ],
            [
                'src' => '/managex/public/screenshots/desktop-dashboard.png',
                'sizes' => '1920x1080',
                'type' => 'image/png',
                'form_factor' => 'wide',
                'label' => 'Tableau de bord ManageX - Desktop',
            ],
        ],
