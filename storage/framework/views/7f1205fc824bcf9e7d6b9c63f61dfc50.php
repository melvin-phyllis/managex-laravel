                    ...
                    <div class="space-y-3 max-h-64 overflow-y-auto pr-2">
                        <?php $__empty_1 = true; $__currentLoopData = $recentEvaluations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evaluation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 hover:bg-gray-100 rounded-xl transition-colors">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 bg-gradient-to-br <?php echo e($config['gradient']); ?> rounded-xl flex items-center justify-center text-white font-bold text-sm shadow-md">
                                ...
                                <span class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-sm font-bold <?php echo e($config['bg']); ?> <?php echo e($config['text']); ?>">
