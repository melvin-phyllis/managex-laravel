...
<?php $component->withAttributes([]); ?>
            ...
            <div class="max-w-7xl mx-auto">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="flex items-center gap-4">
                        <a href="<?php echo e(route('admin.geolocation-zones.index')); ?>" 
                        ...
                        <div>
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 class="text-xl sm:text-2xl font-bold text-white"><?php echo e($geolocationZone->name); ?></h2>
                    ...
                    <div class="flex items-center gap-3 flex-wrap">
                        <div class="flex items-center gap-2">
                            <?php if($geolocationZone->is_active): ?>
                            ...
                            <?php endif; ?>
                            <?php if($geolocationZone->is_default): ?>
                        ...
                        <a href="<?php echo e(route('admin.geolocation-zones.edit', $geolocationZone)); ?>"
            ...
            <div class="lg:col-span-2 space-y-6 order-2 lg:order-1">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-5 space-y-4">
                        <!-- Description -->
                        <?php if($geolocationZone->description): ?>
                            <div>
                                <label class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Description</label>
                                <p class="text-gray-800"><?php echo e($geolocationZone->description); ?></p>
                            </div>
                        <?php endif; ?>

                        <!-- Adresse -->
                        <?php if($geolocationZone->address): ?>
                            <div>
                                ...
                                <p class="text-gray-800 flex items-start gap-2">
                                    ...
                                    <span><?php echo e($geolocationZone->address); ?></span>
                                </p>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="grid grid-cols-2 gap-4 pt-2 border-t border-gray-100">
                            <div>
                                ...
                                <p class="text-gray-800 text-sm"><?php echo e($geolocationZone->created_at->format('d/m/Y')); ?></p>
                                <p class="text-gray-500 text-xs"><?php echo e($geolocationZone->created_at->format('H:i')); ?></p>
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Modifiée le</label>
                                <p class="text-gray-800 text-sm"><?php echo e($geolocationZone->updated_at->format('d/m/Y')); ?></p>
                                <p class="text-gray-500 text-xs"><?php echo e($geolocationZone->updated_at->format('H:i')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center gap-4 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-lg p-3 border border-emerald-100">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-base font-bold text-gray-900 font-mono truncate"><?php echo e(number_format($geolocationZone->latitude, 6)); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-4 bg-gradient-to-r from-teal-50 to-cyan-50 rounded-lg p-3 border border-teal-100">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-base font-bold text-gray-900 font-mono truncate"><?php echo e(number_format($geolocationZone->longitude, 6)); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-4 bg-gradient-to-r from-cyan-50 to-blue-50 rounded-lg p-3 border border-cyan-100">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-base font-bold text-gray-900"><?php echo e($geolocationZone->radius); ?> <span class="text-sm font-normal text-gray-600">métres</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <div class="mt-3 flex items-start gap-2 text-sm text-gray-600 bg-emerald-50 p-3 rounded-lg">
                            ...
                            <span>Le cercle représente la zone de <strong><?php echo e($geolocationZone->radius); ?> métres</strong> dans laquelle les employés peuvent pointer leur présence.</span>
                        </div>
                    </div>
    ...
    <!-- Leaflet JS -->
    <script nonce="<?php echo e($cspNonce ?? ''); ?>" src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"></script>
    <script nonce="<?php echo e($cspNonce ?? ''); ?>">
        document.addEventListener('DOMContentLoaded', function() {
            const lat = <?php echo e($geolocationZone->latitude); ?>;
            const lng = <?php echo e($geolocationZone->longitude); ?>;
            const radius = <?php echo e($geolocationZone->radius); ?>;
            ...
            const popupContent = `
                <div class="text-center">
                    <strong class="text-lg"><?php echo e($geolocationZone->name); ?></strong>
                    <p class="text-gray-600 text-sm mt-1">Rayon: ${radius} m</p>
                    <?php if($geolocationZone->address): ?>
                    <p class="text-gray-500 text-xs mt-1"><?php echo e(Str::limit($geolocationZone->address, 50)); ?></p>
                    <?php endif; ?>
                </div>
            `;
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views\admin\geolocation-zones\show.blade.php ENDPATH**/ ?>