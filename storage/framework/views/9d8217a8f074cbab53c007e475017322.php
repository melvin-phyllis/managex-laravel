                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__currentLoopData = $payrolls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payroll): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <p class="text-lg font-bold text-emerald-600"><?php echo e(number_format($payroll->net_a_payer, 0, ',', ' ')); ?> FCFA</p>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium <?php echo e($status['bg']); ?> <?php echo e($status['text']); ?>">
                        ...
                        <div class="p-4">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-semibold text-gray-900"><?php echo e($payroll->periode); ?></p>
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($status['bg']); ?> <?php echo e($status['text']); ?>">
                                            <?php echo e($status['label']); ?>
