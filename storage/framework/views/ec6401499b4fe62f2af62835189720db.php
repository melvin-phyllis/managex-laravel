            ...
            <div class="relative p-6 md:p-8">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <a href="<?php echo e(route('admin.tutor.evaluations.index')); ?>" 
                        ...
                        <?php endif; ?>
                        <?php if(($stats['pending_evaluations'] ?? 0) > 0): ?>
                        <a href="<?php echo e(route('admin.intern-evaluations.missing')); ?>" 
                           class="inline-flex items-center px-4 py-2.5 bg-amber-500 text-white font-semibold rounded-xl hover:bg-amber-600 transition-all shadow-lg">
                            ...
                            <?php echo e($stats['pending_evaluations'] ?? 0); ?> manquantes
                        </a>
                        <?php endif; ?>
                        <a href="<?php echo e(route('admin.intern-evaluations.report')); ?>" 
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_interns'] ?? 0); ?></p>
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['interns_with_supervisor'] ?? 0); ?></p>
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['evaluations_this_week'] ?? 0); ?></p>
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['average_score'] ?? 0); ?><span class="text-base font-normal text-gray-500">/10</span></p>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-5 py-4 flex items-center justify-between" style="background: linear-gradient(135deg, #5680E9, #5AB9EA);">
                    ...
                    <span class="px-2 py-1 bg-white/20 text-white text-xs font-medium rounded-full">
                        <?php echo e(count($recentEvaluations)); ?> récentes
                    </span>
                </div>
                <div class="p-4">
                    <div class="space-y-3 max-h-64 overflow-y-auto pr-2">
                        <?php $__empty_1 = true; $__currentLoopData = $recentEvaluations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evaluation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                                $gradeConfig = [
                                    'A' => [
                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 hover:bg-gray-100 rounded-xl transition-colors">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-xl flex items-center justify-center text-white font-bold text-sm shadow-md" style="background: <?php echo e($config['gradient']); ?>;">
                                        <?php echo e(strtoupper(substr($evaluation->intern->name ?? 'S', 0, 1))); ?>

                                    </div>
                                    <div>
                                        <p class="font-semibold text-gray-900 text-sm"><?php echo e($evaluation->intern->name ?? 'N/A'); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e($evaluation->week_label); ?></p>
                                    </div>
                                </div>
                                <span class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-sm font-bold" style="background-color: <?php echo e($config['bg']); ?>; color: <?php echo e($config['text']); ?>;">
                                    <?php echo e($evaluation->total_score); ?>/10
                                    <span class="text-xs opacity-75">(<?php echo e($evaluation->grade_letter); ?>)</span>
                                </span>
                            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-5 py-4 flex items-center justify-between" style="background: linear-gradient(135deg, #5680E9, #5AB9EA);">
                ...
                <span class="px-3 py-1 bg-white/20 text-white text-xs font-medium rounded-full">
                    <?php echo e(count($interns)); ?> stagiaires
                </span>
            </div>
                            ...
                            <tr class="hover:bg-blue-50/30 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500"><?php echo e($intern->email); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php if($intern->department): ?>
                                        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-medium bg-slate-100 text-slate-700">
                                            ...
                                            <?php echo e($intern->department->name); ?>
                                    ...
                                    <?php if($intern->supervisor): ?>
                                        <div class="flex items-center gap-2">
                                            <div class="w-7 h-7 rounded-lg flex items-center justify-center text-white font-bold text-xs" style="background: linear-gradient(135deg, #5AB9EA, #84CEEB);">
                                                <?php echo e(strtoupper(substr($intern->supervisor->name, 0, 1))); ?>

                                            </div>
                                            <span class="text-sm font-medium text-gray-700"><?php echo e($intern->supervisor->name); ?></span>
                                        </div>
                                    <?php else: ?>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <span class="inline-flex items-center justify-center w-8 h-8 rounded-lg font-bold text-sm" style="background-color: rgba(90, 185, 234, 0.15); color: #5AB9EA;">
                                        <?php echo e($intern->internEvaluations->count()); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <?php if($intern->internEvaluations->first()): ?>
                                        <?php 
                                        ...
                                        ?>
                                        <span class="inline-flex items-center gap-1 px-3 py-1 rounded-lg text-sm font-bold <?php echo e($config['bg']); ?> <?php echo e($config['text']); ?>">
                                            <?php echo e($lastEval->total_score); ?>/10
                                            <span class="text-xs opacity-75">(<?php echo e($lastEval->grade_letter); ?>)</span>
                                        </span>
                                    <?php else: ?>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <a href="<?php echo e(route('admin.intern-evaluations.show', $intern)); ?>" 
            ...
            if (ctx) {
                new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: [
                                <?php echo e($scoreDistribution['A'] ?? 0); ?>,
                                <?php echo e($scoreDistribution['B'] ?? 0); ?>,
                                <?php echo e($scoreDistribution['C'] ?? 0); ?>,
                                <?php echo e($scoreDistribution['D'] ?? 0); ?>,
                                <?php echo e($scoreDistribution['E'] ?? 0); ?>
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views/admin/intern-evaluations/index.blade.php ENDPATH**/ ?>