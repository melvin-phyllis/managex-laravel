    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['unread']); ?></p>
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-2xl font-bold" style="color: #8590AA;"><?php echo e($stats['pending_ack']); ?></p>
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-2xl font-bold" style="color: #3B8BEB;"><?php echo e($stats['total'] - $stats['unread']); ?></p>
        ...
        <div class="flex flex-wrap gap-2">
            <a href="<?php echo e(route('employee.announcements.index')); ?>" 
               class="px-4 py-2 rounded-lg font-medium transition-all <?php echo e($filter === 'all' ? 'text-white shadow-md' : 'bg-white text-gray-700 hover:bg-gray-50 border border-gray-200'); ?>"
               <?php if($filter === 'all'): ?> style="background-color: #3B8BEB;" <?php endif; ?>>
                Toutes (<?php echo e($stats['total']); ?>)
            </a>
            <a href="<?php echo e(route('employee.announcements.index', ['filter' => 'unread'])); ?>" 
               class="px-4 py-2 rounded-lg font-medium transition-all <?php echo e($filter === 'unread' ? 'text-white shadow-md' : 'bg-white text-gray-700 hover:bg-gray-50 border border-gray-200'); ?>"
               <?php if($filter === 'unread'): ?> style="background-color: #3B8BEB;" <?php endif; ?>>
                Non lues (<?php echo e($stats['unread']); ?>)
            </a>
            <?php if($stats['pending_ack'] > 0): ?>
            <a href="<?php echo e(route('employee.announcements.index', ['filter' => 'acknowledgment'])); ?>" 
               class="px-4 py-2 rounded-lg font-medium transition-all <?php echo e($filter === 'acknowledgment' ? 'text-white shadow-md' : 'border'); ?>"
               style="<?php echo e($filter === 'acknowledgment' ? 'background-color: #8590AA;' : 'background-color: rgba(133, 144, 170, 0.1); color: #8590AA; border-color: rgba(133, 144, 170, 0.3);'); ?>">
                à confirmer (<?php echo e($stats['pending_ack']); ?>)
            </a>
            <?php endif; ?>
        </div>
        ...
        <div class="space-y-4">
            <?php $__empty_1 = true; $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="bg-white rounded-xl shadow-sm border <?php echo e(!$announcement->is_read ? 'border-[#3B8BEB]/30' : 'border-gray-100'); ?> overflow-hidden hover:shadow-md transition-all" style="<?php echo e(!$announcement->is_read ? 'background-color: rgba(59, 139, 235, 0.03);' : ''); ?>">
                    <div class="p-5">
                        <div class="flex flex-col sm:flex-row sm:items-start gap-4">
                            <!-- Icône -->
                            <div class="flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center text-white shadow-sm" style="background-color: <?php echo e($typeColor); ?>;">
                                <?php if($announcement->type === 'urgent'): ?>
                                ...
                                <?php elseif($announcement->type === 'event'): ?>
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <?php if($announcement->requires_acknowledgment && !$announcement->is_acknowledged): ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
                    ...
                    <p class="text-gray-500">
                        ...
                        <?php elseif($filter === 'acknowledgment'): ?>
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views/employee/announcements/index.blade.php ENDPATH**/ ?>