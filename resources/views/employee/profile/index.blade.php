<x-layouts.employee>
    <div class="w-full mx-auto space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 animate-fade-in-up animation-delay-300">
            ...
            <p class="text-xs text-gray-400 mt-4">Ces informations sont gérées par les RH et ne peuvent pas étre modifiées.</p>
        </div>
                    ...
                    <div class="pt-4 border-t border-gray-100">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Né CNPS</label>
