            ...
            <div class="border-l-4 p-4 rounded-r-lg animate-fade-in" style="background: rgba(59, 139, 235, 0.1); border-color: #3B8BEB;" x-data="{ show: true }" x-show="show" x-transition>
                <div class="flex items-start">
                    ...
                    <div class="ml-3 flex-1">
                        ...
                        <p class="mt-1 text-sm" style="color: #8590AA;"><?php echo e(session('success')); ?></p>
                    </div>
...
<?php endif; ?>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 animate-fade-in-up animation-delay-100">
            <!-- Présences -->
            <a href="<?php echo e(route('employee.presences.index')); ?>" class="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 hover:shadow-md transition-all group" style="border-color: rgba(59, 139, 235, 0.2);">
                ...
                <p class="text-xs font-medium mt-1" style="color: #3B8BEB;"><?php echo e($stats['heures_month']); ?>h travaillées</p>
            </a>

            <!-- Tâches -->
            <a href="<?php echo e(route('employee.tasks.index')); ?>" class="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 hover:shadow-md transition-all group" style="border-color: rgba(133, 144, 170, 0.2);">
                <div class="flex items-center justify-between">
                ...
                <p class="text-xs font-medium mt-1" style="color: #8590AA;"><?php echo e($stats['tasks_completed']); ?> terminées</p>
            </a>

            <!-- Congés -->
            <a href="<?php echo e(route('employee.leaves.index')); ?>" class="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 hover:shadow-md transition-all group" style="border-color: rgba(196, 219, 246, 0.3);">
                <div class="flex items-center justify-between">
            ...
            <!-- Sondages -->
            <a href="<?php echo e(route('employee.surveys.index')); ?>" class="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 hover:shadow-md transition-all group" style="border-color: rgba(231, 227, 212, 0.2);">
                <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center justify-between p-2 rounded-lg bg-gray-50">
                                    ...
                                    <?php else: ?>
                                        <span class="text-xs px-2 py-0.5 rounded-full 
                                            <?php if($request->status === 'approved'): ?> text-white
                                            <?php elseif($request->status === 'rejected'): ?> bg-red-100 text-red-700
                                            <?php else: ?> text-white <?php endif; ?>" style="<?php if($request->status === 'approved'): ?> background: #3B8BEB; <?php elseif($request->status === 'pending'): ?> background: #8590AA; <?php endif; ?>">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden animate-fade-in-up">
                <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between" style="background: linear-gradient(90deg, rgba(59, 139, 235, 0.1), rgba(133, 144, 170, 0.08));">
                    ...
                    <a href="<?php echo e(route('employee.tasks.index')); ?>" class="text-sm font-medium hover:opacity-80" style="color: #3B8BEB;">Voir tout</a>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden animate-fade-in-up">
                <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between" style="background: linear-gradient(90deg, rgba(133, 144, 170, 0.1), rgba(196, 219, 246, 0.08));">
                    ...
                    <a href="<?php echo e(route('employee.surveys.index')); ?>" class="text-sm font-medium hover:opacity-80" style="color: #8590AA;">Voir tout</a>
                </div>
                <div class="divide-y divide-gray-50">
                        ...
                        <a href="<?php echo e(route('employee.surveys.show', $survey)); ?>" class="block p-4 hover:bg-gray-50 transition-colors group">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="font-medium text-gray-900 group-hover:opacity-80 transition-colors" style="color: #3B8BEB;"><?php echo e($survey->titre); ?></p>
