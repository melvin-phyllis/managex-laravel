...
<div <?php echo e($attributes->merge(['class' => 'bg-white rounded-xl shadow-sm border border-gray-100 animate-fade-in-up'])); ?>
     ...
     x-data="alertCenter(<?php echo \Illuminate\Support\Js::from($alerts)->toHtml() ?>, '<?php echo e($apiUrl); ?>')"
     x-init="init()">
...
<?php /**PATH D:\ManageX\resources\views/components/alert-center.blade.php ENDPATH**/ ?>