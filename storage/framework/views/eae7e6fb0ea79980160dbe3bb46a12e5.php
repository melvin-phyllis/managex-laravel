...
<?php $component->withAttributes([]); ?>
    <div class="space-y-6">
        ...
        <div class="relative overflow-hidden rounded-2xl p-6 text-white shadow-xl" style="background-color: #3B8BEB;">
            ...
            <div class="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <a href="<?php echo e(route('employee.leaves.index')); ?>" 
                   class="inline-flex items-center gap-2 px-4 py-2 bg-white/20 hover:bg-white/30 text-white rounded-xl transition-colors font-medium">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <form action="<?php echo e(route('employee.leaves.store')); ?>" method="POST" class="p-6 space-y-6">
                <?php echo csrf_field(); ?>

                <!-- Type de congé -->
                <div x-data="{ selectedType: '<?php echo e(old('type', '')); ?>' }">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="date_debut" id="date_debut" 
                                   ...
                                   class="w-full pl-10 rounded-xl border-gray-300 focus:border-[#3B8BEB] focus:ring-[#3B8BEB] <?php $__errorArgs = ['date_debut'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="mt-2 text-sm" style="color: #B23850;"><?php echo e($message); ?></p>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="date_fin" id="date_fin" 
                                   ...
                                   required 
                                   min="<?php echo e(now()->format('Y-m-d')); ?>" 
                                   class="w-full pl-10 rounded-xl border-gray-300 focus:border-[#3B8BEB] focus:ring-[#3B8BEB] <?php $__errorArgs = ['date_fin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="duration-info" class="hidden p-4 rounded-xl" style="background-color: rgba(59, 139, 235, 0.1); border: 1px solid rgba(59, 139, 235, 0.2);">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm font-medium" style="color: #3B8BEB;">Durée de la demande</p>
                ...
                <div>
                    ...
                    <textarea name="motif" id="motif" rows="4" required 
                              class="w-full rounded-xl border-gray-300 focus:border-[#3B8BEB] focus:ring-[#3B8BEB] <?php $__errorArgs = ['motif'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                              placeholder="Expliquez la raison de votre demande..."><?php echo e(old('motif')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="p-4 rounded-xl" style="background-color: rgba(59, 139, 235, 0.1); border: 1px solid rgba(59, 139, 235, 0.2);">
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm mt-1" style="color: rgba(59, 139, 235, 0.8);">Votre demande sera envoyée à l'administrateur pour approbation. Vous recevrez une notification dès qu'une décision sera prise.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-end gap-3 pt-6 border-t border-gray-100">
                    <a href="<?php echo e(route('employee.leaves.index')); ?>" 
                       class="w-full sm:w-auto px-6 py-2.5 text-gray-700 bg-gray-100 hover:bg-gray-200 font-medium rounded-xl transition-colors text-center">
                        Annuler
                    </a>
                    <button type="submit" 
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views/employee/leaves/create.blade.php ENDPATH**/ ?>