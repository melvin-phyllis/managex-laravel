...
<div <?php echo e($attributes->merge(['class' => 'bg-white rounded-xl shadow-sm border border-gray-100 animate-fade-in-up'])); ?>
     ...
     x-data="activityFeed(<?php echo \Illuminate\Support\Js::from($activities)->toHtml() ?>, '<?php echo e($apiUrl); ?>', <?php echo e($pollInterval); ?>)"
     x-init="init()">
    ...
    <div class="max-h-96 overflow-y-auto scrollbar-thin" x-ref="feedContainer">
        ...
        <ul class="divide-y divide-gray-50">
            <template x-for="(activity, index) in activities.slice(0, <?php echo e($maxItems); ?>)" :key="activity.id || index">
    ...
    <template x-if="activities.length > <?php echo e($maxItems); ?>">
...
<?php /**PATH D:\ManageX\resources\views/components/activity-feed.blade.php ENDPATH**/ ?>