...
<?php $component->withAttributes([]); ?>
    <div class="space-y-6">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="px-4 py-2 bg-white/20 backdrop-blur-sm rounded-xl border border-white/30">
                            ...
                            <p class="text-white font-bold text-xl"><?php echo e($evaluations->total()); ?></p>
                        </div>
                        <a href="<?php echo e(route('admin.intern-evaluations.index')); ?>" 
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <form action="<?php echo e(route('admin.intern-evaluations.report')); ?>" method="GET" class="p-5">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                    ...
                    <div>
                        ...
                        <select name="tutor_id" class="w-full rounded-xl border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                            ...
                            <?php $__currentLoopData = $tutors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tutor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($tutor->id); ?>" <?php echo e(request('tutor_id') == $tutor->id ? 'selected' : ''); ?>><?php echo e($tutor->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                    ...
                    <div class="flex items-end gap-2">
                        ...
                        <?php if(request()->hasAny(['department_id', 'tutor_id', 'date_from', 'date_to'])): ?>
                            <a href="<?php echo e(route('admin.intern-evaluations.report')); ?>" class="px-4 py-2.5 bg-gray-100 text-gray-700 font-medium rounded-xl hover:bg-gray-200 transition-colors">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        <div class="w-10 h-10 bg-gradient-to-br <?php echo e($config['gradient']); ?> rounded-xl flex items-center justify-center text-white font-bold text-sm shadow-md">
                                            <?php echo e(strtoupper(substr($evaluation->intern->name ?? 'S', 0, 2))); ?>

                                        </div>
                                        <div>
                                            <p class="font-semibold text-gray-900"><?php echo e($evaluation->intern->name ?? 'N/A'); ?></p>
                                            <p class="text-xs text-gray-500"><?php echo e($evaluation->intern->department->name ?? ''); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <?php if($evaluation->tutor): ?>
                                        <div class="flex items-center gap-2">
                                            <div class="w-7 h-7 bg-gradient-to-br from-indigo-400 to-violet-500 rounded-lg flex items-center justify-center text-white font-bold text-xs">
                                                <?php echo e(strtoupper(substr($evaluation->tutor->name, 0, 1))); ?>

                                            </div>
                                            <span class="text-sm font-medium text-gray-700"><?php echo e($evaluation->tutor->name); ?></span>
                                        </div>
                                    <?php else: ?>
            ...
            <?php if($evaluations->hasPages()): ?>
                <div class="px-6 py-4 border-t border-gray-100 bg-gray-50">
                    <?php echo e($evaluations->withQueryString()->links()); ?>
...
<?php endif; ?>
<?php /**PATH D:\ManageX\resources\views\admin\intern-evaluations\report.blade.php ENDPATH**/ ?>